...
|DRESSER[98]||外圆磨砂轮右端面,磨削中是否修整标记(0不修整/1修整)
...
|DRESSER[109]||外圆磨砂轮左端面,磨削中是否修整标记(0不修整/1修整)
|DRESSER[110]||外圆磨砂轮外圆是否修整(0修整/1不修整)
|||
|**初始化参数(INI)**||
...
|PROCESS[34]||磨削中心:左端面磨削初始接触工件位置
|PROCESS[35]||磨削中心:左端面磨削进给速度
|PROCESS[36]||磨削中心:右端端面磨削进给速度
|PROCESS[37]||磨削中心:右端面磨削初始接触工件位置
