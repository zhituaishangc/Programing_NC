...
|||
|DRESSER[25]|D_DRESS_TIME_R|纯修整粗修次数界面设定值
|DRESSER[26]|D_DRESS_TIME_F|纯修整精修次数界面设定值
|DRESSER[27]|D_DRESS_DEEP_R|纯修整粗修进给界面设定值
|DRESSER[28]|D_DRESS_DEEP_F|纯修整精修进给界面设定值
|DRESSER[29]|D_DRESS_FEED_R|纯修整粗修速度界面设定值
|DRESSER[30]|D_DRESS_FEED_F|纯修整精修速度界面设定值
|||
...
|DRESSER[98]||外圆磨砂轮侧面修整,标记(0不修整/1修整)
...
|DRESSER[106]||外圆磨砂轮侧面修整,粗修进给量)
|DRESSER[107]||外圆磨砂轮侧面修整,精修进给量)
|DRESSER[108]||外圆磨砂轮侧面修整,粗修进给速度)
|DRESSER[109]||外圆磨砂轮侧面修整,精修进给速度)
|DRESSER[110]||外圆磨砂轮侧面修整,Z轴修整当前位置)
|||
|**初始化参数(INI)**||
...
|PROCESS[26]|SN_RIGHT_FACE_GRIND_DEEP|右端面磨削进给量
|PROCESS[27]|SN_RIGHT_FACE_GRIND_U|右端面磨削单面壁厚
