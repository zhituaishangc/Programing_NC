...
namespace 界面自动拼接
{
	...
	public class FormAdd
	{
		...
		public static void AddGrindParameterForm(string grindType)//磨削参数
		{
			...
			{
				case "外螺纹":
					sourcePath=@"界面源文件\磨削参数_外.txt";
					break;
				case "内螺纹":
					sourcePath=@"界面源文件\磨削参数_内.txt";
					break;
				case "磨削中心":
					sourcePath=@"界面源文件\磨削参数_磨削中心.txt";
					break;
				default:
					sourcePath=@"界面源文件\磨削参数_外.txt";
					break;
