...
|$A_DBB[7]|DB4900.DBX7.0|自动对刀测量机构1汽缸回退到位(接近开关)
|$A_DBB[8]|DB4900.DBX8.0|自动对刀测量机构1汽缸伸出到位(接近开关)
...
|$A_DBB[17]|DB4900.DBX17.0|液压卡盘夹紧时为1，松开为0
|$A_DBB[18]|DB4900.DBX18.0|液压卡盘松开时为1，夹紧为0
|$A_DBB[19]|DB4900.DBX19.0|zc插补期间x退刀，同步动作信号
|$A_DBB[20]|DB4900.DBX20.0|自动对刀测量机构2汽缸回退到位(测量头)
|$A_DBB[21]|DB4900.DBX21.0|自动对刀测量机构2汽缸伸出到位(测量头)
|||与桁架机器人交互相关的信号
