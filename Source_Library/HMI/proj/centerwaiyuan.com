...
//M(MASK31/$85709/"panel_31_1_chs.png"/)
	DEF VAR20=(I/*0=$85166,1=$85167//$85170,$85170,,/WR2/"panel_31_1_chs.png"/"/NC/_N_NC_GD2_ACX/INI[98]"/360,10,70/460,10,80/);单件/批量磨削方式选择
	...
	DEF TUIDAOCAO=(R/0,10//$85702,$85702,,/WR2/"panel_31_2_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[113]"/360,130,202/460,130,60/);退刀槽长度

	DEF ZIDONGCELIANG=(R///$85720,$85720,,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[44]"/360,160,202/460,160,60/);自动对刀测量外圆面初始接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR2/"panel_31_4_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[47]"/360,180,202/460,180,60/6);初始磨削接触位
	DEF VAR19=(R///$85158,$85158,,/WR2/"panel_31_3_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[21]"/360,200,202/460,200,60/);当前磨削接触位

	DEF X_QUIT=(R/-800,800//$85714,$85714,,/WR2/"panel_31_5_chs.png"/"/NC/_N_NC_GD2_ACX/INI[108]"/360,240,202/460,240,60/);退刀位置
	DEF Z_INIT=(R/-2000,2000//$85101,$85101,,/WR2/"panel_31_6_chs.png"/"/NC/_N_NC_GD2_ACX/INI[109]"/360,260,202/460,260,60/);磨外圆部分时台面起始位置
	...
	DEF X_IM=(R///$85118,$85118,,/WR1//"$AA_IM[X]"/10,10,20/30,10,60/);X_IM ifIsNotHasU
	DEF U_IM=(R///$85121,$85121,,/WR1//"$AA_IM[U]"/10,10,20/30,10,60/);U_IM ifIsHasU
...
//M(MASK26/$85711/"panel_26_1_chs.png"/)
	...
	DEF ZUIDU=(R///$85724,$85724,,$85043/WR2/"panel_26_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[133]"/110,40,110/200,40,110/);外圆修整锥度微调(正 左低右高/负 左高右低)

	DEF VAR4=(I/*0=$85327,1=$85328//$85350,$85350,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[90]"/330,10,110/440,10,60/);砂轮状态

	DEF VAR5=(I/0,1000//$85340,$85340,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[83]"/330,40,110/440,40,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[85]"/330,60,110/440,60,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[87]"/330,80,110/440,80,110/);粗修速度

	DEF VAR8=(I/0,1000//$85341,$85341,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[84]"/330,110,120/440,110,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[86]"/330,130,110/440,130,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[88]"/330,150,110/440,150,110/);精修速度

	DEF DRESS_START=(R///$85715,$85715,,$85043/WR2/"panel_26_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[94]"/330,180,110/440,180,110/);修整起点
	DEF DRESS_END=(R///$85716,$85716,,$85043/WR2/"panel_26_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[73]"/330,200,110/440,200,110/);修整终点
	...
	DEF DQJC=(R///$85718,$85718,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[89]"/330,320,110/440,320,60/);当前接触
	DEF CSJC=(R///$85717,$85717,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[120]"/330,340,110/440,340,60/);初始接触
