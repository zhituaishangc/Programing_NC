...
//M(MASK31/$85709//)
	...
	DEF VAR19=(R///$85158,$85158,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[21]"/360,110,202/460,110,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[47]"/360,130,202/460,130,60/);初始磨削接触位
	DEF ZIDONGCELIANG=(R///$85720,$85720,,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[44]"/360,150,202/460,150,60/);自动对刀测量外圆面初始接触位

	DEF X_QUIT=(R/-800,800//$85714,$85714,,/WR2//"/NC/_N_NC_GD2_ACX/INI[108]"/360,190,202/460,190,60/);退刀位置
	DEF Z_INIT=(R/-2000,2000//$85813,$85813,,/WR2//"/NC/_N_NC_GD2_ACX/INI[109]"/360,210,202/460,210,60/);磨外圆部分时台面起始位置
