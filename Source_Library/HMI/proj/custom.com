...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	;DEF M_OR_L=(I/*0=$85179,1=$85178//,,,/WR4/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/INI[87]"/0,0,0/360,10,70/);选择输入模数0还是输入螺距1
...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	;DEF VAR3=(I/*0=$85383,1=$85384,2=$85385//$85389,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[5]"/0,0,0/220,30,60/);齿形
	;DEF MODEL_NAME=(S///$85177,$85177,,/WR4//"/NC/_N_NC_GD2_ACX/WORM_SHAPE"/0,0,0/300,30,130/);存储齿形程序名,蜗杆用,注释不可改
...
//M(Mask5/$85381//)
	...
	DEF VAR4=(R/-500,500//$85393,$85393,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110/);初始右端接触位置

	DEF VAR5=(R/-500,500//$85394,$85394,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110/);当前左端接触位置
	DEF VAR6=(R/-500,500//$85395,$85395,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110/);当前右端接触位置
...
//M(Mask10/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR3=(I/*0=$85383,1=$85384,2=$85385//$85389,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[5]"/0,0,0/335,30,60/);齿形,界面调试用,注释不可改
	;DEF VAR3=(I/*0=$85383,1=$85384,2=$85385//$85389,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[5]"/0,0,0/220,30,60/);齿形
	;DEF MODEL_NAME=(S///$85177,$85177,,/WR1//"/NC/_N_NC_GD2_ACX/WORM_SHAPE"/0,0,0/300,30,130/);存储齿形程序名,蜗杆用,注释不可改
	DEF ROLLING_1=(I/*0=$85379,1=$85379/0/$85388,,,/WR4///0,0,0/440,10,60/);成型修整轮
	DEF HY_1=(I/*0=$85378,1=$85378/0/$85388,,,/WR4///0,0,0/440,10,60/);液压修整
