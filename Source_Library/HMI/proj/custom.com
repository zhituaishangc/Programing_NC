...
//M(MASK31/$85709//)
	...
	DEF ZIDONGCELIANG=(R///$85720,$85720,,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[44]"/360,210,202/460,210,60/);自动对刀测量外圆面初始接触位
...
//M(MASK33/$85028/"panel_33_0_chs.png"/)
	...
	DEF VAR5=(R/0,100//$85719,$85719,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[56]"/10,40,110/110,40,110/);台阶距左端面距离

	DEF VAR9=(R///$85712,$85712,,/WR1///10,103,202/110,103,60/);工件右端
	DEF VAR8=(R///$85713,$85713,,/WR1///10,129,202/110,129,60/);工件左端
