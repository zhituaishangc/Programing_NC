...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF WHEEL_W_MIN=(R/0,1000//$85303,$85303,,$85043/WR4/"panel_3_10_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[36]"/310,310,130/440,310,110/);砂轮最小直径
	DEF WHEEL_W_MAX=(R/0,1000//$85305,$85305,,$85043/WR4/"panel_3_11_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[50]"/310,330,130/440,330,110/);砂轮最大磨削直径
	DEF WHEEL_N_MIN=(R/0,1000//$85303,$85303,,$85043/WR4/"panel_3_12_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[36]"/310,310,130/440,310,110/);砂轮最小直径
	DEF WHEEL_N_MAX=(R/0,1000//$85304,$85304,,$85043/WR4/"panel_3_13_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[50]"/310,330,130/440,330,110/);砂轮最大磨削直径
	...
	;DEF MODEL_NAME=(S///$85464,$85464,,/WR4//"/NC/_N_NC_GD2_ACX/WORM_SHAPE"/0,0,0/300,30,130/);存储齿形程序名,蜗杆用,注释不可改
...
//M(Mask10/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR3=(I/*0=$85383,1=$85384,2=$85385//$85389,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[5]"/0,0,0/335,30,60/);齿形,界面调试用,注释不可改
	;DEF MODEL_NAME=(S///$85464,$85464,,/WR1//"/NC/_N_NC_GD2_ACX/WORM_SHAPE"/0,0,0/300,30,130/);存储齿形程序名,蜗杆用,注释不可改
	DEF ROLLING_1=(I/*0=$85379,1=$85379/0/$85388,,,/WR4///0,0,0/440,10,60/);成型修整轮
	DEF HY_1=(I/*0=$85378,1=$85378/0/$85388,,,/WR4///0,0,0/440,10,60/);液压修整
	...
	DEF WHEEL_MAX=(R/0,1000//$85304,$85304,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[50]"/310,330,130/440,330,110/);砂轮最大磨削直径
...
//M(MASK31/$85709//)
	...
	DEF GRIND_ORI=(I/*0=$85722,1=$85723//$85721,$85721,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[132]"/360,40,70/460,40,60/);外圆磨削方向(0从里往外1从外往里)
...
//M(MASK24/$85710/"panel_2_0_chs.png"/)
	...
	;单双磨削选择
	DEF VAR10=(I/*0=$85233,1=$85234//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[240]"/0,0,0/132,78,60);
	DEF VAR11=(I/*0=$85233,1=$85234//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[241]"/0,0,0/222,78,60);
	DEF VAR12=(I/*0=$85233,1=$85234//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[242]"/0,0,0/312,78,60);
	DEF VAR13=(I/*0=$85233,1=$85234//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[243]"/0,0,0/402,78,60);	
...
//M(Mask21/$85026/"panel_21_2_chs.png"/)
	...
	DEF ERGAO=(R/0,100//$85801,$85801,,$85043/WR2/"panel_21_16_chs.png"/"/NC/_N_NC_GD2_ACX/INI[44]"/10,330,130/140,330,110/);工件耳高
