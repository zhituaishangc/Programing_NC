...
//M(MASK31/$85709//)
	...
	DEF VAR8=(R///$85712,$85712,,/WR1///360,50,202/460,50,60/);工件左端
	DEF VAR9=(R///$85713,$85713,,/WR1///360,70,202/460,70,60/);工件右端
	DEF VAR1=(R////WR4//"/NC/_N_NC_GD2_ACX/PROCESS[49]"/0,0,0/0,0,0/);左端面当前接触
	DEF VAR2=(R////WR4//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/0,0,0/0,0,0/);右端面当前接触

	DEF X_QUIT=(R/-800,800//$85714,$85714,,/WR2//"/NC/_N_NC_GD2_ACX/INI[108]"/360,110,202/460,110,60/);退刀位置
	DEF Z_INIT=(R/-2000,2000//$85813,$85813,,/WR2//"/NC/_N_NC_GD2_ACX/INI[109]"/360,130,202/460,130,60/);磨外圆部分时台面起始位置

	DEF VAR19=(R///$85158,$85158,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[21]"/360,170,202/460,170,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[47]"/360,190,202/460,190,60/);初始磨削接触位
...
//M(MASK26/$85711//)
	...
	DEF CSJC=(R///$85717,$85717,,/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[120]"/330,320,110/440,320,60/);初始接触
	DEF DQJC=(R///$85718,$85718,,/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[89]"/330,340,110/440,340,60/);当前接触
...
//M(MASK27/$85711//)
	...
	DEF VAR10=(R///$85717,$85717,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[127]"/330,280,110/440,280,60/);Z轴修整初始位置
    DEF VAR11=(R///$85718,$85718,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[109]"/330,300,110/440,300,60/);Z轴修整当前位置
