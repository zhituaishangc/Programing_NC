...
//M(MASK23/$85066//)
	...
	DEF VAR1=(I/*0=$85014,1=$85013//$85031,$85031,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[42]"/400,60,70/490,60,30);内螺纹磨削开关
	DEF VAR2=(I/*0=$85014,1=$85013//$85032,$85032,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[44]"/400,90,70/490,90,30);外圆磨削开关
	DEF VAR3=(I/*0=$85014,1=$85013//$85033,$85033,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[45]"/400,120,100/490,120,30);左端面磨削开关
	DEF VAR4=(I/*0=$85014,1=$85013//$85034,$85034,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[46]"/400,150,100/490,150,30);右端面磨削开关
	
	DEF VAR5=(S///,$85067,,/wr1///400,200,200,/);修整开关设置
	DEF VAR6=(I/*0=$85014,1=$85013//$85068,$85068,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND[2]"/400,230,100/490,230,30/);螺纹修整开关
	DEF VAR7=(I/*0=$85014,1=$85013//$85069,$85069,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[6]"/400,260,100/490,260,30);外圆修整开关
	DEF VAR8=(I/*0=$85014,1=$85013//$85070,$85070,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[7]"/400,290,/490,290,30);端面修整开关
...
//M(Mask25/$85029//)
	;左端面部分
	DEF VAR2=(R///$85072,$85072,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[49]"/40,230,140/160,230,60/);左端面Z轴对刀位置
	DEF VAR3=(R///$85075,$85075,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESS[35]"/40,50,140/160,50,60/);左端面Z轴当前接触位置
    DEF VAR4=(I/0,100//$85209,$85209,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/40,80,120/160,80,110/);左端面磨削设定循环次数
	DEF VAR5=(R/0,1//$85230,$85230,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[41]"/40,110,120/160,110,110/);左端面磨削进给量
    
	DEF VAR6=(R///$85220,$85220,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[40]"/40,140,120/160,140,110/);C轴转速
	DEF VAR7=(R///$85215,$85215,,$85045/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/40,170,120/160,170,110/);左端面磨削速度
	DEF VAR8=(I/0,100//$85210,$85210,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[107]"/40,200,120/160,200,110/);左端面磨削中修整设定	
    DEF VAR9=(R///$85222,$85222,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[105]"/40,50,120/160,50,110/);磨削量累计
	
	;右端面部分

	DEF VAR10=(R///$85073,$85073,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/320,260,120/440,260,60/);右端面Z轴对刀位置
	DEF VAR11=(R///$85076,$85076,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESS[38]"/320,50,140/440,50,60/);右端面Z轴当前接触位置
    DEF VAR12=(I/0,100//$85209,$85209,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[102]"/320,80,120/440,80,110/);右端面磨削设定循环次数
	DEF VAR13=(R/0,1//$85230,$85230,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[27]"/320,110,120/440,110,110/);右端面磨削进给量
    DEF VAR14=(R///$85077,$85077,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[28]"/320,140,120/440,140,110/);右端面U轴插补进给深度
	DEF VAR15=(R///$85220,$85220,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[39]"/320,170,120/440,170,110/);C轴转速
	DEF VAR16=(R///$85215,$85215,,$85045/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/320,200,120/440,200,110/);右端面磨削速度
	DEF VAR17=(I/0,100//$85210,$85210,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[106]"/320,230,120/440,230,110/);右端面磨削中修整设定	
    DEF VAR18=(R///$85222,$85222,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[104]"/320,50,150/440,50,110/);右端面累计磨削量
...
//M(MASK26/$85035//)
	...
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[92]"/330,300,110/440,300,110/);砂轮当前直径
...
//M(MASK27/$85018//)
    ...
    DEF VAR11=(R///$85037,$85037,,/WR1/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[109]"/330,270,110/440,270,60/);Z轴修整当前位置
