...
//M(Mask13/$85381//)
	...
	DEF VAR11=(R/-2000,2000//$85342,$85342,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,20,110/440,20,110/);砂轮修整轮中心
	DEF VAR0=(R/0,300//$85390,$85390,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[3]"/330,40,110/440,40,110/);双滚轮间距
...
//M(Mask16/$85379/"panel_16_1_chs.png"/)
	...
	DEF VAR12=(R/-2000,2000//$85342,$85342,,$85043/WR2/"panel_16_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/325,70,110/440,70,110/);砂轮修整轮中心
	;DEF VAR20=(R/-2000,2000//$85808,$85808,,$85043/WR2/"panel_16_8_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[48]"/325,90,115/440,90,110/);砂轮开到修整端面位置
...
//M(MASK31/$85709//)
	...
	DEF VAR8=(R///$85108,$85108,,/WR1///360,100,202/460,100,60/);工件左端
	DEF VAR9=(R///$85109,$85109,,/WR1///360,120,202/460,120,60/);工件右端
	DEF VAR1=(R///$85108,$85108,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESS[49]"/0,0,0/0,0,0/);左端面当前接触
	DEF VAR2=(R///$85109,$85109,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/0,0,0/0,0,0/);右端面当前接触

	DEF X_QUIT=(R/-500,500//$85106,$85106,,$85043/WR2//"/NC/_N_NC_GD2_ACX/INI[108]"/360,170,202/460,170,110/);退刀位置

	DEF VAR19=(R///$85158,$85158,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[21]"/360,200,202/460,200,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[47]"/360,220,202/460,220,60/);初始磨削接触位
...
//M(MASK24/$85710/"panel_2_0_chs.png"/)
	...
	;磨削几件后修整
	DEF WORK_CUMU=(I///$85227,$85227,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[94]"/230,1,110/300,1,110/);磨削工件计数(磨削完毕后累加)
	DEF WORK_DRESS=(I///$85229,$85229,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[95]"/230,20,110/300,20,110/);磨削几件后修整(次数到达后,下一次开始时修整)
...
//M(MASK26/$85711//)
	...
	DEF CSJC=(R///$85036,$85036,,/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[120]"/330,240,110/440,240,60/);初始接触
	DEF DQJC=(R///$85037,$85037,,/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[89]"/330,260,110/440,260,60/);当前接触
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[91]"/330,280,110/440,280,110/);新砂轮直径
	...
	CHANGE(CSJC)
		...
		VAR14.VAL=VAR13.VAL-VAR0.VAL*2
	END_CHANGE
...
//M(MASK32/$85709//)
	...
	;左端面参数
	DEF VAR2=(R///$85708,$85708,,$85043/WR2//"/NC/_N_NC_GD2_ACX/INI[44]"/360,40,202/460,40,110/);耳高
	DEF VAR3=(R///$85180,$85180,,/WR1///360,60,202/460,60,60/);工件上端
	DEF VAR4=(R///$85181,$85181,,/WR1///360,80,202/460,80,60/);工件下端
	DEF VAR5=(R///$85158,$85158,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[35]"/360,100,202/460,100,60/);当前磨削接触位
	DEF VAR6=(R///$85169,$85169,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[49]"/360,120,202/460,120,60/);初始磨削接触位

	;右端面参数
	DEF VAR7=(R///$85077,$85077,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[28]"/360,150,202/460,150,110/);孔厚
	DEF VAR8=(R///$85180,$85180,,/WR1///360,170,202/460,170,60/);工件上端
	DEF VAR9=(R///$85181,$85181,,/WR1///360,190,202/460,190,60/);工件下端
	DEF VAR10=(R///$85158,$85158,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[38]"/360,210,202/460,210,60/);当前磨削接触位
	DEF VAR11=(R///$85169,$85169,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/360,230,202/460,230,60/);初始磨削接触位
...
//M(Mask25/$85710/"panel_2_0_chs.png"/)

	;单双磨削选择
	DEF VAR10=(I/*0=$85120,1=$85121//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[73]"/0,0,0/132,78,60);左端面粗磨
	DEF VAR11=(I/*0=$85120,1=$85121//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[74]"/0,0,0/222,78,60);左端面精磨
	DEF VAR12=(I/*0=$85120,1=$85121//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[75]"/0,0,0/312,78,60);右端面粗磨
	DEF VAR13=(I/*0=$85120,1=$85121//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[76]"/0,0,0/402,78,60);右端面精磨

	;循环次数
	DEF VAR15=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/0,0,0/132,104,60/);左端面粗磨次数
	DEF VAR16=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[244]"/0,0,0/222,104,60/);左端面精磨次数
	DEF VAR17=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[102]"/0,0,0/312,104,60/);右端面粗磨次数
	DEF VAR18=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[245]"/0,0,0/402,104,60/);右端面精磨次数
	
	;进给深度
	DEF VAR19=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[79]"/0,0,0/132,129,60);左端面粗磨进给量
	DEF VAR20=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[80]"/0,0,0/222,129,60);左端面精磨进给量
	DEF VAR21=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[81]"/0,0,0/312,129,60);右端面粗磨进给量
	DEF VAR22=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[82]"/0,0,0/402,129,60);右端面精磨进给量
	
	;磨削速度
	DEF VAR27=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[85]"/0,0,0/132,154,60/);左端面粗磨速度
	DEF VAR28=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[86]"/0,0,0/222,154,60/);左端面精磨速度
	DEF VAR29=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[87]"/0,0,0/312,154,60/);右端面粗磨速度
	DEF VAR30=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[88]"/0,0,0/402,154,60/);右端面精磨速度

	;磨削几次修整设定
	DEF VAR41=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[256]"/0,0,0/132,179,60/);左端面粗磨
	DEF VAR42=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[257]"/0,0,0/222,179,60/);左端面精磨
	DEF VAR43=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[258]"/0,0,0/312,179,60/);右端面粗磨
	DEF VAR44=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[259]"/0,0,0/402,179,60/);右端面精磨
	
	;砂轮线速度设定
	DEF VAR37=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[67]"/0,0,0/132,203,60/);左端面粗磨砂轮线速度
	DEF VAR38=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[68]"/0,0,0/222,203,60/);左端面精磨砂轮线速度
	DEF VAR39=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[69]"/0,0,0/312,203,60/);右端面粗磨砂轮线速度
	DEF VAR40=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[70]"/0,0,0/402,203,60/);右端面精磨砂轮线速度
	
	;头架转速显示
	DEF VAR23=(R///,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[91]"/0,0,0/132,245,60/);左端面粗磨头架转速
	DEF VAR24=(R///,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[92]"/0,0,0/222,245,60/);左端面精磨头架转速
	DEF VAR25=(R///,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[93]"/0,0,0/312,245,60/);右端面粗磨头架转速
	DEF VAR26=(R///,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[94]"/0,0,0/402,245,60/);右端面精磨头架转速

	;砂轮转速显示
	DEF VAR32=(R///,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[92]"/0,0,0/0,0,0/);当前砂轮直径调用
	DEF VAR33=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[260]"/0,0,0/132,266,60/);左端面粗磨砂轮转速
	DEF VAR34=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[261]"/0,0,0/222,266,60/);左端面精磨砂轮转速
	DEF VAR35=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[262]"/0,0,0/312,266,60/);右端面粗磨砂轮转速
	DEF VAR36=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[263]"/0,0,0/402,266,60/);右端面精磨砂轮转速
	...
	DEF VAR102=(R///$85222,$85222,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[62]"/230,5,190/320,5,60/);累计磨削总量显示
	DEF VAR103=(R///$85220,$85219,$85043,/WR1///230,25,190/320,25,60/);界面设定磨削总量显示
	;磨削几件后修整
	DEF WORK_CUMU=(I///$85227,$85227,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[94]"/420,1,110/470,1,110/);磨削工件计数(磨削完毕后累加)
	DEF WORK_DRESS=(I///$85229,$85229,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[95]"/420,20,110/470,20,110/);磨削几件后修整(次数到达后,下一次开始时修整)
...
//M(MASK27/$85711//)
	...
	DEF VAR10=(R///$85036,$85036,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[127]"/330,250,110/440,250,60/);Z轴修整初始位置
    DEF VAR11=(R///$85037,$85037,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[109]"/330,270,110/440,270,60/);Z轴修整当前位置
	DEF VAR15=(R/0,80//$85317,$85317,,$85046/WR2//"NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[42]"/330,300,110/440,300,110/);砂轮线速度
	
	DEF VAR14=(R////WR2//"NC/_N_NC_GD2_ACX/DRESSER[92]"/0,0,0/0,0,0/);砂轮当前直径
	DEF VAR16=(I///$85318,$85318,,$85044/WR1//""/330,340,110/440,340,110/);修整时砂轮转速
