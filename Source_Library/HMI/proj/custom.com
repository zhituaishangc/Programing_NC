...
//M(MASK31/$85709//)
	...
	DEF X_QUIT=(R/-500,500//$85106,$85106,,/WR2//"/NC/_N_NC_GD2_ACX/INI[108]"/360,170,202/460,170,60/);退刀位置

	DEF VAR19=(R///$85158,$85158,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[21]"/10,330,210/120,330,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[47]"/10,350,210/120,350,60/);初始磨削接触位
...
//M(MASK26/$85711//)
	...
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR2///330,300,110/440,300,110/);砂轮当前直径
...
//M(MASK32/$85709//)
	...
	;左端面参数
	DEF VAR2=(R///$85708,$85708,,$85043/WR2//"/NC/_N_NC_GD2_ACX/INI[44]"/360,40,202/460,40,60/);耳高
	...
	;右端面参数
	DEF VAR7=(R///$85077,$85077,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[28]"/360,150,202/460,150,60/);孔厚
...
//M(Mask25/$85710/"panel_2_0_chs.png"/)
	...
	;砂轮转速显示
	DEF VAR32=(R///,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[92]"/0,0,0/0,0,0/);当前砂轮直径调用
	DEF VAR33=(I///,,,/WR1///0,0,0/132,266,60/);左端面粗磨砂轮转速
	DEF VAR34=(I///,,,/WR1///0,0,0/222,266,60/);左端面精磨砂轮转速
	DEF VAR35=(I///,,,/WR1///0,0,0/312,266,60/);右端面粗磨砂轮转速
	DEF VAR36=(I///,,,/WR1///0,0,0/402,266,60/);右端面精磨砂轮转速
	...
	;磨削几件后修整
	DEF WORK_CUMU=(I///$85227,$85227,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[94]"/400,1,110/570,1,110/);磨削工件计数(磨削完毕后累加)
	DEF WORK_DRESS=(I///$85229,$85229,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[95]"/400,20,110/570,20,110/);磨削几件后修整(次数到达后,下一次开始时修整)
	...
	SUB(UP3)
		VAR14.VAL=VAR15.VAL*VAR19.VAL+VAR16.VAL*VAR20.VAL
	END_SUB

	SUB(UP4)
		VAR14.VAL=VAR17.VAL*VAR21.VAL+VAR18.VAL*VAR22.VAL
	END_SUB
...
//M(MASK27/$85711//)
	...
	DEF VAR15=(R/0,80//$85212,$85212,,$85043/WR2//"NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[42]"/330,300,110/440,300,110/);砂轮线速度
