...
//M(MASK33/$85028//)
	...
	DEF VAR5=(R/0,100//$85719,$85719,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[56]"/10,10,110/110,10,110/);台阶距左端面距离

	DEF VAR9=(R///$85712,$85712,,/WR1///10,50,202/110,50,60/);工件右端
	DEF VAR8=(R///$85713,$85713,,/WR1///10,70,202/110,70,60/);工件左端
	DEF VAR1=(R////WR4//"/NC/_N_NC_GD2_ACX/PROCESS[35]"/0,0,0/0,0,0/);左端面当前接触
	DEF VAR2=(R////WR4//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/0,0,0/0,0,0/);右端面初始接触

	DEF VAR19=(R///$85158,$85158,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[109]"/10,170,202/110,170,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[21]"/10,190,202/110,190,60/);初始磨削接触位

	;单双磨削选择
	DEF VAR12=(I/*0=$85120,1=$85121//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[106]"/0,0,0/312,78,60);
	DEF VAR13=(I/*0=$85120,1=$85121//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[107]"/0,0,0/402,78,60);	

	;循环次数
	DEF VAR17=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[266]"/0,0,0/312,104,60/);精磨次数
	DEF VAR18=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[267]"/0,0,0/402,104,60/);终磨次数
	
	;进给深度
	DEF VAR21=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[100]"/0,0,0/312,129,60);精磨进给量
	DEF VAR22=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[101]"/0,0,0/402,129,60);终磨进给量
	
	;磨削速度
	DEF VAR29=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[103]"/0,0,0/312,154,60/);精磨速度
	DEF VAR30=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[104]"/0,0,0/402,154,60/);终磨速度
	...
	;头架转速显示
	DEF VAR25=(R///,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[97]"/0,0,0/312,245,60/);半精磨头架转速
	DEF VAR26=(R///,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[98]"/0,0,0/402,245,60/);精磨头架转速
	...
	;界面设定磨削总量计算
	DEF VAR102=(R///$85222,$85222,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[108]"/215,5,190/305,5,60/);累计磨削总量显示
