...
//M(Mask30/$85021/"panel_20_0_chs.png"/)
	...
	;头架转速显示
	DEF VAR23=(R///$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[61]"/0,0,0/148,317,60/);粗磨头架转速
	DEF VAR24=(R///$85204,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[62]"/0,0,0/238,317,60/);半粗磨头架转速
	DEF VAR25=(R///$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[63]"/0,0,0/328,317,60/);半精磨头架转速
	DEF VAR26=(R///$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[64]"/0,0,0/418,317,60/);精磨头架转速
	DEF VAR31=(R///,,,/WR4//"/NC/_N_NC_GD2_ACX/INI[5]"/0,0,0/0,0,0/);螺距调用
	DEF TouShou=(R///,,,/WR4//"/NC/_N_NC_GD2_ACX/WORK[1]"/0,0,0/0,0,0/);工件头数调用
...
//M(MASK31/$85709//)
	...
	CHANGE(VAR1)
		VAR9.VAL=VAR1.VAL+TUIDAOCAO.VAL+0.1
...
//M(MASK33/$85028/"panel_33_0_chs.png"/)
	...
	;单双磨削选择
	DEF VAR12=(I/*0=$85233,1=$85234//$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[106]"/0,0,0/312,103,60);
	DEF VAR13=(I/*0=$85233,1=$85234//$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[107]"/0,0,0/402,103,60);	
...
//M(Mask25/$85710/"panel_25_0_chs.png"/)
	...
	;单双磨削选择
	DEF VAR10=(I/*0=$85233,1=$85234//$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[73]"/0,0,0/132,103,60);左端面粗磨
	DEF VAR11=(I/*0=$85233,1=$85234//$85204,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[74]"/0,0,0/222,103,60);左端面精磨
	DEF VAR12=(I/*0=$85233,1=$85234//$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[75]"/0,0,0/312,103,60);右端面粗磨
	DEF VAR13=(I/*0=$85233,1=$85234//$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[76]"/0,0,0/402,103,60);右端面精磨
