...
//M(Mask4/$85380/"panel_4_1_chs.png"/)
	...
	DEF W_IM=(R///$85115,$85115,,/WR1//"$AA_IM[W]"/10,30,20/30,30,60/3);W_IM

	DEF VAR0=(R/0,300//$85614,$85614,,$85043/WR4//""/330,60,110/440,60,110/);滚轮间距

	DEF VAR1=(R/0,10//$85612,$85612,,$85043/WR2/"panel_4_2_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[5]"/330,90,110/440,90,110//"UserGuide/section_4.html","S4D1");圆弧半径
	DEF VAR2=(R/0,10//$85611,$85611,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[6]"/330,110,110/440,110,110/);右圆弧半径

	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR2/"panel_4_3_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110//"UserGuide/section_4.html","S4D2");初始接触位置
	DEF VAR4=(R/-500,500//$85617,$85617,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110/);初始右端接触位置

	DEF VAR5=(R/-500,500//$85623,$85623,,$85043/WR2/"panel_4_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110//"UserGuide/section_4.html","S4D3");当前接触位置
	DEF VAR6=(R/-500,500//$85619,$85619,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110/);当前右端接触位置

	DEF VAR7=(R/0,500//$85620,$85620,,$85043/WR2/"panel_4_5_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[1]"/330,240,110/440,240,110//"UserGuide/section_4.html","S4D4");修整轮直径
	DEF VAR8=(R/0,60//$85621,$85621,,$85046/WR2/"panel_4_6_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[2]"/330,260,110/440,260,110//"UserGuide/section_4.html","S4D5");修整轮线速度
	...
	DEF VAR11=(R/-2000,2000//$85608,$85608,,$85043/WR2/"panel_4_1_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D6");砂轮修整轮中心
...
//M(Mask6/$85382//)
	...
	DEF VAR11=(R/-500,500//$85608,$85608,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D6");砂轮修整轮中心
	DEF VAR0=(R/0,100//$85615,$85615,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[4]"/330,60,110/440,60,110//"UserGuide/section_4.html","S4D7");方滚轮厚度

	DEF VAR1=(R/0,10//$85610,$85610,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[9]"/330,90,110/440,90,110//"UserGuide/section_4.html","S4D1");左圆弧半径
	DEF VAR2=(R/0,10//$85611,$85611,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[10]"/330,110,110/440,110,110//"UserGuide/section_4.html","S4D1");右圆弧半径

	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110//"UserGuide/section_4.html","S4D2");初始接触位置
	DEF VAR4=(R/-500,500//$85617,$85617,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110//"UserGuide/section_4.html","S4D2");初始右端接触位置

	DEF VAR5=(R/-500,500//$85623,$85623,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110//"UserGuide/section_4.html","S4D3");当前接触位置
	DEF VAR6=(R/-500,500//$85619,$85619,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110//"UserGuide/section_4.html","S4D3");当前右端接触位置
	...
	DEF VAR8=(R/0,60//$85621,$85621,,$85045/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[2]"/330,260,110/440,260,110//"UserGuide/section_4.html","S4D5");修整轮线速度
...
//M(Mask5/$85381//)
	...
	DEF VAR11=(R/-500,500//$85609,$85608,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,20,110/440,20,110//"UserGuide/section_4.html","S4D6");砂轮修整轮中心
	DEF para_switch=(I/*0=$85058,1=$85059//$85063,$85063,,/WR2//"/NC/_N_NC_GD2_ACX/PARA_LOCK_SWITCH[2]"/0,0,0/530,20,18/);参数锁定开关

	DEF VAR0=(R/0,300//$85614,$85614,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[3]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D8");双滚轮间距

	DEF VAR1=(R/0,10//$85610,$85610,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[7]"/330,70,110/440,70,110//"UserGuide/section_4.html","S4D1");左圆弧半径
	DEF VAR2=(R/0,10//$85611,$85611,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[8]"/330,90,110/440,90,110//"UserGuide/section_4.html","S4D1");右圆弧半径

	DEF VAR9=(R/-5,5//$85613,$85613,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[16]"/330,120,110/440,120,110//"UserGuide/section_4.html","S4D9");左右轮高度差
	DEF VAR3=(R/-500,500//$85616,$85616,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110//"UserGuide/section_4.html","S4D2");初始左端接触位置
	DEF VAR4=(R/-500,500//$85617,$85617,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110//"UserGuide/section_4.html","S4D2");初始右端接触位置

	DEF VAR5=(R/-500,500//$85618,$85618,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110//"UserGuide/section_4.html","S4D3");当前左端接触位置
	DEF VAR6=(R/-500,500//$85619,$85619,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110//"UserGuide/section_4.html","S4D3");当前右端接触位置
...
//M(Mask11/$85379/"panel_11_1_chs.png"/)
	...
	DEF V_IM=(R///$85114,$85114,,/WR1//"$AA_IM[V]"/10,10,20/30,10,60/3);V_IM
	DEF W_IM=(R///$85115,$85115,,/WR1//"$AA_IM[W]"/10,30,20/30,30,60/3);W_IM  ifIsVW
	...
	;+++++++++++++++++++++++++++++++
	DEF Z_CENTER=(R/-2000,2000//$85608,$85608,,$85043/WR2/"panel_4_1_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D6");砂轮修整轮中心 ifIsVW
...
//M(Mask12/$85380/"panel_12_1_chs.png"/)
	...
	DEF VAR11=(R/-2000,2000//$85607,$85608,,$85043/WR2/"panel_12_1_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D13");砂轮修整轮中心
	...
	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR1/"panel_12_3_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110//"UserGuide/section_4.html","S4D14");初始接触位置
	DEF VAR4=(R/-500,500//$85617,$85617,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110/);初始右端接触位置

	DEF VAR5=(R/-500,500//$85623,$85623,,$85043/WR2/"panel_12_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110//"UserGuide/section_4.html","S4D15");当前接触位置
	DEF VAR6=(R/-500,500//$85619,$85619,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110/);当前右端接触位置
...
//M(Mask14/$85382//)
	...
	DEF VAR12=(R/-800,800//$85601,$85601,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[3]"/330,20,110/440,20,110//"UserGuide/section_4.html","S4D12");回零时砂轮与修整轮中间距
	DEF para_switch2=(I/*0=$85058,1=$85059//$85063,$85063,,/WR2//"/NC/_N_NC_GD2_ACX/PARA_LOCK_SWITCH[11]"/0,0,0/530,20,18/);参数锁定开关

	DEF VAR11=(R/-2000,2000//$85608,$85608,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D13");砂轮修整轮中心
	...
	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110//"UserGuide/section_4.html","S4D14");初始接触位置
	DEF VAR4=(R/-500,500//$85617,$85617,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110//"UserGuide/section_4.html","S4D14");初始右端接触位置

	DEF VAR5=(R/-500,500//$85623,$85623,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110//"UserGuide/section_4.html","S4D15");当前接触位置
	DEF VAR6=(R/-500,500//$85619,$85619,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110//"UserGuide/section_4.html","S4D15");当前右端接触位置
...
//M(Mask13/$85381//)
	...
	DEF VAR11=(R/-2000,2000//$85608,$85608,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,20,110/440,20,110//"UserGuide/section_4.html","S4D12");砂轮修整轮中心
	DEF VAR0=(R/0,300//$85614,$85614,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[3]"/330,40,110/440,40,110//"UserGuide/section_4.html","S4D8");双滚轮间距
	...
	DEF VAR9=(R/-5,5//$85613,$85613,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[16]"/330,120,110/440,120,110//"UserGuide/section_4.html","S4D9");左右轮高度差
	DEF VAR3=(R/-500,500//$85616,$85616,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110//"UserGuide/section_4.html","S4D14");初始左端接触位置
	DEF VAR4=(R/-500,500//$85617,$85617,,$85043/WR3//"/NC/_N_NC_GD2_ACX/WHEEL[14]"/330,160,110/440,160,110//"UserGuide/section_4.html","S4D14");初始右端接触位置

	DEF VAR5=(R/-500,500//$85618,$85618,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,190,110/440,190,110//"UserGuide/section_4.html","S4D15");当前左端接触位置
	DEF VAR6=(R/-500,500//$85619,$85619,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[12]"/330,210,110/440,210,110//"UserGuide/section_4.html","S4D15");当前右端接触位置
...
//M(Mask16/$85379/"panel_16_1_chs.png"/)
	...
	DEF VAR0=(R/-800,800//$85601,$85601,,$85043/WR2/"panel_16_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/325,40,110/440,40,110//"UserGuide/section_4.html","S4D12");回零时两轮中间距
	...
	DEF VAR12=(R/-2000,2000//$85608,$85608,,$85043/WR2/"panel_16_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/325,70,110/440,70,110//"UserGuide/section_4.html","S4D13");砂轮修整轮中心
	...
	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/325,280,110/440,280,110//"UserGuide/section_4.html","S4D14");初始接触位置
	DEF VAR5=(R/-500,500//$85623,$85623,,$85043/WR1/"panel_16_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/325,300,110/440,300,110//"UserGuide/section_4.html","S4D15");当前接触位置
...
//M(Mask17/$85379/"panel_17_1_chs.png"/)
	...
	DEF VAR12=(R/-2000,2000//$85608,$85608,,$85043/WR2/"panel_17_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/325,70,110/440,70,110//"UserGuide/section_4.html","S4D13");砂轮与修整轮Z中心
	...
	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/325,280,130/440,280,110//"UserGuide/section_4.html","S4D14");初始接触位置
	DEF VAR5=(R/-500,500//$85623,$85623,,$85043/WR1/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/325,300,130/440,300,110//"UserGuide/section_4.html","S4D15");当前接触位置
...
//M(Mask15/$85379//)
	...
	DEF VAR1=(R/-500,500//$85603,$85603,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,140,110/440,140,110/);NC用初始接触
	DEF VAR3=(R/-500,500//$85622,$85622,,$85043/WR2//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/330,160,110/440,160,110/);初始接触位置
