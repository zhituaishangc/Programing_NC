...
//M(MASK32/$85709/"panel_32_1_chs.png"/)
	...
	DEF VAR1=(I/*0=$85166,1=$85167//$85170,$85170,,/WR2/"panel_32_1_chs.png"/"/NC/_N_NC_GD2_ACX/INI[104]"/360,10,70/460,10,80/);单件/批量磨削方式选择

	;左端面参数
	DEF VAR2=(R///$85801,$85801,,$85043/WR2/"panel_32_2_chs.png"/"/NC/_N_NC_GD2_ACX/INI[44]"/60,40,202/160,40,110/);耳高
	DEF VAR3=(R///$85700,$85700,,/WR1///60,70,202/160,70,60/);磨削起点
	DEF VAR4=(R///$85701,$85701,,/WR1///60,90,202/160,90,60/);磨削终点
	DEF VAR6=(R///$85169,$85169,,/WR2/"panel_32_4_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[49]"/60,120,202/160,120,60/6);初始磨削接触位
	DEF VAR5=(R///$85158,$85158,,/WR2/"panel_32_4_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[35]"/60,140,202/160,140,60/);当前磨削接触位

	;右端面参数
	DEF VAR7=(R///$85800,$85800,,$85043/WR2/"panel_32_3_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[28]"/360,40,202/460,40,110/);孔厚
	DEF VAR8=(R///$85700,$85700,,/WR1///360,70,202/460,70,60/);磨削起点
	DEF VAR9=(R///$85701,$85701,,/WR1///360,90,202/460,90,60/);磨削终点
	DEF VAR11=(R///$85169,$85169,,/WR2/"panel_32_5_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[48]"/360,120,202/460,120,60/6);初始磨削接触位
	DEF VAR10=(R///$85158,$85158,,/WR2/"panel_32_5_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[38]"/360,140,202/460,140,60/);当前磨削接触位
...
//M(MASK27/$85711/"panel_27_1_chs.png"/)
	...
	DEF ZUIDU=(R///$85724,$85724,,$85043/WR2/"panel_27_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[137]"/110,40,110/200,40,110/);端面修整锥度微调(正 前大后小/负 前小后大)

	DEF WHEEL_STATUS=(I/*0=$85327,1=$85328//$85350,$85350,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[130]"/330,10,110/440,10,60/);砂轮状态

	DEF VAR2=(I/0,1000//$85340,$85340,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[95]"/330,40,110/440,40,60/);粗修次数
	DEF VAR3=(R/0,0.5//$85308,$85308,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[97]"/330,60,110/440,60,110/);粗修量
	DEF VAR4=(R/0,1000//$85306,$85306,,$85045/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[103]"/330,80,110/440,80,110/);粗修速度

	DEF VAR5=(I/0,1000//$85341,$85341,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[96]"/330,110,120/440,110,60/);精修次数
	DEF VAR6=(R/0,0.5//$85309,$85309,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[98]"/330,130,110/440,130,110/);精修量
	DEF VAR7=(R/0,1000//$85307,$85307,,$85045/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[104]"/330,150,110/440,150,110/);精修速度

	DEF VAR8=(R///$85715,$85715,,/WR2/"panel_27_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[101]"/330,180,110/440,180,60/);U轴修整起点
	DEF VAR9=(R///$85716,$85716,,/WR2/"panel_27_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[102]"/330,200,110/440,200,60/);U轴修整深度
