...
//M(MASK23/$85027/"panel_23_6_chs.png"/)
	...
	;内螺纹:
	DEF NEI_JISHU=(I///$85227,$85227,,$85228/WR2//"/NC/_N_NC_GD2_ACX/INI[74]"/200,10,100/300,10,110//"UserGuide/section_2.html","S2D1");磨削工件计数(磨削完毕后累加)
	DEF NEI_PILIANG=(I/*0=$85166,1=$85167//$85170,$85170,,/WR2//"/NC/_N_NC_GD2_ACX/INI[27]"/200,30,100/300,30,80//"UserGuide/section_1.html","S1D1");单件/批量磨削方式选择
	DEF NEI_ZHONGJIN=(R///$85174,$85174,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[5]"/200,50,100/300,50,60//"UserGuide/section_1.html","S1D2");单次中径调整值
	DEF NEI_PIANDAO=(R/-100,100//$85175,$85175,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[43]"/200,70,100/300,70,60//"UserGuide/section_1.html","S1D3");Z轴偏刀调整
	...
	;*DEF ZHONGCICUN=(R///$85210,$85210,,/WR1//"/NC/_N_NC_GD2_ACX/INI[124]"/200,130,100/300,130,60/);终尺寸H

	DEF NEI_XINSHALUN=(I/*0=$85327,1=$85328//$85350,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/390,70,60//"UserGuide/section_3.html","S3D16");砂轮状态
	DEF NEI_CHUXIU=(I/0,1000//$85340,$85340,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[26]"/390,90,100/490,90,60//"UserGuide/section_3.html","S3D7");粗修次数
	...
	DEF NEI_GONGYI=(I/*0=$85710,1=$85710/0/$85710,$85710,,/WR2///0,0,0/390,30,70//"UserGuide/section_28.html","S28D1");工艺界面

	DEF BAIN_ENABLE=(I/*0=$85546,1=$85547//$85538,$85538,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[60]"/0,0,0/480,10,70//"UserGuide/section_28.html","S28D2");使能

	;外圆：
	DEF WAI_PILIANG=(I/*0=$85166,1=$85167//$85170,$85170,,/WR2//"/NC/_N_NC_GD2_ACX/INI[98]"/200,170,100/300,170,80//"UserGuide/section_26.html","S26D3");单件/批量磨削方式选择
	...
	DEF WAI_CHUXIU=(I/0,1000//$85340,$85340,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[83]"/200,230,100/300,230,60//"UserGuide/section_26.html","S26D21");粗修次数

	DEF WAI_GONGYI=(I/*0=$85710,1=$85710/0/$85710,$85710,,/WR2///0,0,0/390,170,70//"UserGuide/section_28.html","S28D3");工艺界面

	;*DEF ZAIXIANCELIANGSTATUS=(I/*0=$85014,1=$85013//$85707,$85707,,/WR1//"$A_IN[10]"/390,210,100/460,210,30/);在线测量状态

	;端面：
	DEF DUANMIAN_PILAING=(I/*0=$85166,1=$85167//$85170,$85170,,/WR2//"/NC/_N_NC_GD2_ACX/INI[104]"/200,280,100/300,280,80//"UserGuide/section_27.html","S27D3");单件/批量磨削方式选择
	...
	DEF DUANMIAN_CHUXIU=(I/0,1000//$85340,$85340,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[95]"/200,340,100/300,340,60//"UserGuide/section_27.html","S27D23");粗修次数
	...
	DEF DUAN_GONGYI=(I/*0=$85710,1=$85710/0/$85710,$85710,,/WR2///0,0,0/390,280,70//"UserGuide/section_28.html","S28D4");工艺界面


	DEF X_IM=(R///$85118,$85118,,/WR1//"$AA_IM[X]"/10,10,20/60,10,60/3);X_IM
	DEF Z_IM=(R///$85119,$85119,,/WR1//"$AA_IM[Z]"/10,30,20/60,30,60/3);Z_IM
	DEF C_IM=(R///$85120,$85120,,/WR1//"$AA_IM[C]"/10,50,20/60,50,60/3);C_IM
	DEF U_IM=(R///$85121,$85121,,/WR1//"$AA_IM[U]"/10,70,20/60,70,60/3);U_IM ifIsHasU
	DEF A_IM=(R///$85122,$85122,,/WR1//"$AA_IM[A]"/10,90,20/60,90,60/3);A_IM

	DEF X_DRF=(R///$85116,$85116,,/WR1//"$AC_DRF[X]"/10,120,50/60,120,60/7);DRF_X
	DEF Z_DRF=(R///$85117,$85117,,/WR1//"$AC_DRF[Z]"/10,140,50/60,140,60/7);DRF_Z
	...
	DEF ZUO_CS=(R///$85185,$85185,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[49]"/10,280,100/110,280,60/6/"UserGuide/section_27.html","S27D6");初始磨削接触位
	DEF ZUO_DQ=(R///$85186,$85186,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[35]"/10,300,100/110,300,60//"UserGuide/section_27.html","S27D7");当前磨削接触位

	DEF YOU_CS=(R///$85187,$85187,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/10,325,100/110,325,60/6/"UserGuide/section_27.html","S27D10");初始磨削接触位
	DEF YOU_DQ=(R///$85188,$85188,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[38]"/10,345,100/110,345,60//"UserGuide/section_27.html","S27D11");当前磨削接触位
