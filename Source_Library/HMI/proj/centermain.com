...
//M(MASK23/$85027/"panel_23_6_chs.png"/)
	...
	DEF NEI_CS=(R///$85180,$85180,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,170,100/110,170,60/6);初始磨削接触位
	...
	DEF WAI_CS=(R///$85183,$85183,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[47]"/10,235,100/110,235,60/6);初始磨削接触位
	DEF WAI_DQ=(R///$85184,$85184,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[21]"/10,255,100/110,255,60/);当前磨削接触位

	DEF ZUO_CS=(R///$85185,$85185,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[49]"/10,280,100/110,280,60/6);初始磨削接触位
	DEF ZUO_DQ=(R///$85186,$85186,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[35]"/10,300,100/110,300,60/);当前磨削接触位

	DEF YOU_CS=(R///$85187,$85187,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[48]"/10,325,100/110,325,60/6);初始磨削接触位
