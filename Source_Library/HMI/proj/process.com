...
//M(Mask2/$85021/"panel_2_0_chs.png"/)
	...
	DEF VAR19=(R///$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[131]"/0,0,0/132,129,60//"UserGuide/section_2.html","S2D5");粗磨进给量 ;ifIsNotRoughToAmount
	...
	;砂轮线速度设定
	DEF VAR37=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[161]"/0,0,0/132,203,60//"UserGuide/section_2.html","S2D7");粗磨砂轮线速度
	DEF VAR38=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[162]"/0,0,0/222,203,60//"UserGuide/section_2.html","S2D7");半粗磨砂轮线速度
	DEF VAR39=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[163]"/0,0,0/312,203,60//"UserGuide/section_2.html","S2D7");半精磨砂轮线速度
	DEF VAR40=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[164]"/0,0,0/402,203,60//"UserGuide/section_2.html","S2D7");精磨砂轮线速度
	...
	;*DEF WAIJING=(R/0,300//$85207,$85207,,$85043/WR2//"/NC/_N_NC_GD2_ACX/INI[121]"/35,290,100/130,290,110/);工件外径
	;*DEF SANXIAN=(R/0,300//$85208,$85208,,$85043/WR2//"/NC/_N_NC_GD2_ACX/INI[122]"/35,310,100/130,310,110/);三线测量
	;*DEF GANGQIU=(R/0,100//$85209,$85209,,$85043/WR2//"/NC/_N_NC_GD2_ACX/INI[123]"/35,330,100/130,330,110/);钢球直径
	;*DEF ZHONGCICUN=(R///$85210,$85210,,$85043/WR1//"/NC/_N_NC_GD2_ACX/INI[124]"/35,350,100/130,350,110/);终尺寸H
	...
	DEF VAR14=(R///$85220,$85219,$85043,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[13]"/30,20,190/130,20,50//"UserGuide/section_2.html","S2D9");工艺磨削总量显示 ;ifIsNotRoughToAmount
	...
	CHANGE(VAR14);界面设定磨削总量计算 ;ifIsNotRoughToAmount
		CALL("UP3")
	END_CHANGE
	...
	SUB(UP3)
		...
		VAR19.VAL=(VAR14.VAL-(VAR16.VAL*VAR20.VAL+VAR17.VAL*VAR21.VAL+VAR18.VAL*VAR22.VAL))/VAR15.VAL ;ifIsNotRoughToAmount
	END_SUB
	...
	SUB(DIY_ON)
		...
		VAR14.WR=1 ;ifIsNotRoughToAmount
		VAR20.WR=1
		VAR21.WR=1
		VAR22.WR=1
		;磨削速度
	...
	SUB(DIY_OFF)
		...
		VAR14.WR=2 ;ifIsNotRoughToAmount
		VAR20.WR=2
		VAR21.WR=2
		VAR22.WR=2
		;磨削速度
...
//M(Mask29/$85021/"panel_2_0_chs.png"/)
	...
	;砂轮线速度设定
	DEF VAR37=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[221]"/0,0,0/132,203,60//"UserGuide/section_2.html","S2D7");粗磨砂轮线速度
	DEF VAR38=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[222]"/0,0,0/222,203,60//"UserGuide/section_2.html","S2D7");半粗磨砂轮线速度
	DEF VAR39=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[223]"/0,0,0/312,203,60//"UserGuide/section_2.html","S2D7");半精磨砂轮线速度
	DEF VAR40=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[224]"/0,0,0/402,203,60//"UserGuide/section_2.html","S2D7");精磨砂轮线速度
...
//M(Mask20/$85021/"panel_20_0_chs.png"/)
	...
	DEF VAR19=(R///$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[131]"/0,0,0/148,117,60);粗磨进给量 ;ifIsNotRoughToAmount
	...
	DEF GRID_TOTAL_ACC=(R///$85222,$85222,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[15]"/30,1,190/120,1,60/);累计磨削总量显示
	DEF VAR14=(R///$85220,$85219,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[13]"/30,20,190/130,20,50/);工艺磨削总量显示 ;ifIsRoughToAmount
	DEF VAR14=(R///$85220,$85219,$85043,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[13]"/30,20,190/130,20,50/);工艺磨削总量显示 ;ifIsNotRoughToAmount
	DEF DIY_MSG=(R///,$85223,,/WR4//""/30,20,300/0,0,0);DIY_MSG
	;磨削几件后修整
