;调用通用齿形步骤：
;将下面对应界面替换到shape.com中,注意根据机床类型对按键的屏蔽
;变量表修改DRESSER[114]=1
...
//M(Mask9/$85400/"panel_9_15_chs.png"/)
	...
	DEF VAR5=(R/0,50//$85434,$85434,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[113]"/0,0,0/170,103,60/);初始左滚道
	DEF VAR6=(R/0,50//$85435,$85435,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[114]"/0,0,0/170,128,60/);初始右滚道

	DEF VAR7=(R/-10,10//$85436,$85436,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[117]"/0,0,0/260,103,60/);调整左滚道
	DEF VAR8=(R/-10,10//$85437,$85437,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[118]"/0,0,0/260,128,60/);调整右滚道
	...
	DEF VAR11=(R/0,10//$85441,$85441,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[115]"/0,0,0/170,178,60/);原始左滚道水平偏心
	DEF VAR12=(R/0,10//$85442,$85442,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[116]"/0,0,0/170,203,60/);原始右滚道水平偏心

	DEF VAR15=(R/-10,10//$85449,$85449,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[119]"/0,0,0/260,178,60/);左滚道水平偏心调整
	DEF VAR16=(R/-10,10//$85450,$85450,,/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[120]"/0,0,0/260,203,60/);右滚道水平偏心调整
	...
	DEF VAR40=(R/20,90//$85495,$85495,,$85042/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[89]"/70,10,125/180,10,110/);圆弧部分角度

	DEF VAR41=(R/0,90//$85408,$85408,,$85042/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[85]"/70,30,125/180,30,110/);过度1斜线角度
	DEF VAR42=(R/0,20//$85409,$85409,,$85043/WR2//"/NC/_N_NC_GD2_ACX/SHAPE_MODEL[88]"/70,50,125/180,50,110/);过度2斜线长度
