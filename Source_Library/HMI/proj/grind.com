...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF VAR4=(I/*0=$85110,1=$85111//$85141,,,/WR2/"panel_1_1_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[9]"/0,0,0/270,10,70//"UserGuide/section_1.html","S1D5");对刀类型(首次/二次)
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR2/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/270,30,70//"UserGuide/section_1.html","S1D6");选择对刀位置
	DEF DUIDAOWEI=(R///$85112,$85112,,/WR4/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/INI[135]"/245,50,50/280,50,60//"UserGuide/section_1.html","S1D7");任意点对刀位
	;ifIsHasReOperateEnd
	...
	DEF SCREW_R=(I/*0=$85124,1=$85125//$85103,$85103,,/WR2/"panel_1_4_chs.png"/"/NC/_N_NC_GD2_ACX/INI[1]"/360,40,70/460,40,60//"UserGuide/section_1.html","S1D8");螺纹旋向
	...
	DEF VAR8=(R3/-2000,2000//$85108,$85108,,/WR2/"panel_1_7_chs.png"/"/NC/_N_NC_GD2_ACX/INI[2]"/360,100,202/460,100,60//"UserGuide/section_1.html","S1D10");工件左端
	DEF VAR9=(R3/-2000,2000//$85109,$85109,,/WR2/"panel_1_8_chs.png"/"/NC/_N_NC_GD2_ACX/INI[3]"/360,120,202/460,120,60//"UserGuide/section_1.html","S1D11");工件右端
	DEF VAR10=(R/-500,500//$85165,$85165,,/WR2/"panel_1_9_chs.png"/"/NC/_N_NC_GD2_ACX/INI[11]"/360,150,202/460,150,60//"UserGuide/section_1.html","S1D12");对刀起始位置
	DEF GRIND_SAFE=(R/-500,500//$85172,$85172,,/WR2/"panel_1_23_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[17]"/360,170,202/460,170,60//"UserGuide/section_1.html","S1D13");磨削安全位置
	DEF X_QUIT=(R/-500,500//$85106,$85106,,/WR2/"panel_1_10_chs.png"/"/NC/_N_NC_GD2_ACX/INI[24]"/360,190,202/460,190,60//"UserGuide/section_1.html","S1D14");退刀位置
	...
	DEF VAR20=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_1_12_chs.png"/"/NC/_N_NC_GD2_ACX/INI[12]"/360,270,80/405,270,30//"UserGuide/section_1.html","S1D16");是否有锥度
	DEF VAR21=(I/-10,10//$85160,,,$85052/WR2/"panel_1_13_chs.png"/"/NC/_N_NC_GD2_ACX/INI[13]"/0,0,0/460,270,85//"UserGuide/section_1.html","S1D17");锥度分子,默认内螺纹大头往小头磨,外螺纹小头往大头磨
	DEF VAR22=(I/0,800//$85161,,,/WR2/"panel_1_14_chs.png"/"/NC/_N_NC_GD2_ACX/INI[14]"/0,0,0/505,270,40//"UserGuide/section_1.html","S1D18");锥度分母

	DEF VAR23=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2/"panel_1_18_chs.png"/"/NC/_N_NC_GD2_ACX/INI[39]"/360,290,80/405,290,30//"UserGuide/section_1.html","S1D19");螺旋升角自动计算
	...
	DEF SHOUJIAN=(I/*0=$85087,1=$85088//$85089,,,/WR2/"panel_1_24_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[58]"/0,0,0/200,350,70//"UserGuide/section_1.html","S1D27");是否是首件工件
...
//M(Mask18/$85020/"panel_18_4_chs.png"/)
	...
	DEF VAR8=(R3/-2000,2000//$85108,$85108,,/WR2/"panel_18_7_chs.png"/"/NC/_N_NC_GD2_ACX/INI[2]"/360,100,202/460,100,60//"UserGuide/section_1.html","S1D10");工件左端
	DEF VAR9=(R3/-2000,2000//$85109,$85109,,/WR2/"panel_18_8_chs.png"/"/NC/_N_NC_GD2_ACX/INI[3]"/360,120,202/460,120,60//"UserGuide/section_1.html","S1D11");工件右端
	DEF VAR10=(R/-500,500//$85165,$85165,,/WR2/"panel_18_9_chs.png"/"/NC/_N_NC_GD2_ACX/INI[11]"/360,150,202/460,150,60//"UserGuide/section_1.html","S1D28");工件中心
	DEF X_QUIT=(R/-500,500//$85106,$85106,,/WR2/"panel_18_25_chs.png"/"/NC/_N_NC_GD2_ACX/INI[24]"/360,170,202/460,170,60//"UserGuide/section_1.html","S1D14");退刀位置
	...
	DEF Z_INIT=(R/-2000,2000//$85101,$85101,,/WR2/"panel_18_23_chs.png"/"/NC/_N_NC_GD2_ACX/INI[29]"/360,240,202/460,240,60//"UserGuide/section_1.html","S1D30");内螺纹时台面起始位置

	DEF VAR20=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_18_12_chs.png"/"/NC/_N_NC_GD2_ACX/INI[12]"/360,270,80/405,270,30//"UserGuide/section_1.html","S1D16");是否有锥度
	DEF VAR21=(I/-10,10//$85160,,,$85052/WR2/"panel_18_13_chs.png"/"/NC/_N_NC_GD2_ACX/INI[13]"/0,0,0/460,270,85//"UserGuide/section_1.html","S1D17");锥度分子,默认内螺纹大头往小头磨,外螺纹小头往大头磨
	DEF VAR22=(I/0,800//$85161,,,/WR2/"panel_18_14_chs.png"/"/NC/_N_NC_GD2_ACX/INI[14]"/0,0,0/505,270,40//"UserGuide/section_1.html","S1D18");锥度分母

	DEF VAR23=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2/"panel_18_18_chs.png"/"/NC/_N_NC_GD2_ACX/INI[39]"/360,290,80/405,290,30//"UserGuide/section_1.html","S1D19");螺旋升角自动计算
	...
	DEF SHOUJIAN=(I/*0=$85087,1=$85088//$85089,,,/WR2/"panel_18_27_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[58]"/0,0,0/200,350,70//"UserGuide/section_1.html","S1D27");是否是首件工件
