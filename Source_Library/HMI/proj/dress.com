...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	;以下4个参数按需选择一个类型
	;+++++++++++++++++++++++++++++++++++++++++++++
	DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348//$85387,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/335,10,60/);修整器
	...
	DEF N_CX_X_TYPE=(I////WR4//"/NC/_N_NC_GD2_ACX/DRESSER[38]"/0,0,0/0,0,0/);成型X修整时修整器在前/后
