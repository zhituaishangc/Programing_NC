...
//M(Mask1/$85020//)
	...
	DEF VAR10=(R/-500,500//$85106,$85106,$85043,/WR2//"/NC/_N_NC_GD2_ACX/INI[11]"/340,160,202/440,160,60/);退刀位置
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148,3=$85149//$85145,,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/240,35,70/);对刀位置
	...
	DEF VAR23=(I/*0=$85014,1=$85013/0/$85164,$85164,,/WR1//"/NC/_N_NC_GD2_ACX/INI[17]"/335,285,80/370,285,50/);是否有螺旋升角
	DEF VAR24=(I/-45,45//$85160,,,$85042/WR2//"/NC/_N_NC_GD2_ACX/INI[18]"/0,285,0/435,285,75/);度
	DEF VAR25=(I/0,59//$85161,,,$85053/WR2//"/NC/_N_NC_GD2_ACX/INI[19]"/0,285,0/470,285,70/);分
	DEF VAR26=(I/0,59//$85161,,,$85054/WR2//"/NC/_N_NC_GD2_ACX/INI[20]"/0,285,0/500,285,70/);秒
...
//M(Mask2/$85021/"panel_2_0.png"/)
	...
	DEF VAR0=(I/*0=$85217,1=$85216//$85218,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[1]"/0,0,0/45,53,65/1,9);DIY
	...
	END_CHANGE
	CHANGE(VAR37)
		VAR33.VAL=VAR37.VAL/VAR32.VAL
	END_CHANGE
	CHANGE(VAR38)
		VAR34.VAL=VAR38.VAL/VAR32.VAL
	END_CHANGE
	CHANGE(VAR39)
		VAR35.VAL=VAR39.VAL/VAR32.VAL
	END_CHANGE
	CHANGE(VAR40)
		VAR36.VAL=VAR40.VAL/VAR32.VAL
	END_CHANGE		
	SUB(UP2)
