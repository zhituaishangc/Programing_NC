...
//M(Mask9/$85385/"panel_9_1_chs.png"/)
	...
	CHANGE(VAR9)
		IF (VAR4.VAL<>1.588)AND(VAR4.VAL<>2.381)AND(VAR4.VAL<>3.175)AND(VAR4.VAL<>3.969)AND(VAR4.VAL<>4.763)AND(VAR4.VAL<>5.953)AND(VAR4.VAL<>7.144)AND(VAR4.VAL<>9.525)AND(VAR4.VAL<>12.7)
			VAR5.VAL=VAR9.VAL;
		ENDIF
		call("UP4")
	END_CHANGE
