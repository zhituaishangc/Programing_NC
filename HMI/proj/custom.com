...
//M(Mask3/$85022//)
	...
	DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/1/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/335,10,60/);修整器
	...
	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR2/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/440,50,60/);砂轮1状态
	DEF VAR40=(I/*0=$85014,1=$85013//$85806,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[46]"/0,0,0/505,50,30/);砂轮1是否修整
	DEF VAR5=(I/0,1000//$85340,$85340,,/WR2/"panel_3_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[26]"/330,70,110/440,70,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR2/"panel_3_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[28]"/330,90,110/440,90,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR2/"panel_3_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[30]"/330,110,110/440,110,110/);粗修速度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR2/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[24]"/330,130,110/440,130,110/);新砂轮1直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,150,110/440,150,110/);砂轮1当前直径
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/330,170,110/440,170,110/);修整时砂轮1转速

	DEF VAR23=(I/*0=$85800,1=$85801//$85350,,,/WR2/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[41]"/0,0,0/440,220,60/);砂轮2状态
	DEF VAR41=(I/*0=$85014,1=$85013//$85807,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[47]"/0,0,0/505,220,30/);砂轮2是否修整
	DEF VAR8=(I/0,1000//$85341,$85341,,/WR2/"panel_3_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[27]"/330,240,110/440,240,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR2/"panel_3_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[29]"/330,260,110/440,260,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR2/"panel_3_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[31]"/330,280,110/440,280,110/);精修速度
	DEF VAR24=(R/0,1000//$85802,$85802,,$85043/WR2/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[38]"/330,300,110/440,300,110/);新砂轮2直径
	DEF VAR25=(R/0,1000//$85803,$85803,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[39]"/330,320,110/440,320,110/);砂轮2当前直径
	DEF VAR27=(I///$85805,$85805,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[44]"/330,340,110/440,340,110/);修整时砂轮2转速
	...
	DEF VAR26=(R/0,1000//$85804,$85804,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[40]"/80,300,110/210,300,110/);砂轮1&2中心距
	DEF WHEEL1_MIN=(R/0,100//$85810,$85810,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[36]"/80,320,130/210,320,110/);砂轮1最小直径
	DEF WHEEL2_MIN=(R////WR4//"/NC/_N_NC_GD2_ACX/DRESSER[45]"/0,0,0/0,0,0/);砂轮2最小直径
	DEF WHEEL_MAX=(R/0,100//$85811,$85811,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[50]"/80,340,130/210,340,110/);砂轮最大磨削直径
...
//M(Mask10/$85022//)
	...
	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/440,50,60/);砂轮1状态
	DEF VAR40=(I/*0=$85014,1=$85013//$85806,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[46]"/0,0,0/505,50,30/);砂轮1是否修整
	DEF VAR5=(I/0,1000//$85340,$85340,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[26]"/330,70,110/440,70,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[28]"/330,90,110/440,90,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[30]"/330,110,110/440,110,110/);粗修速度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[24]"/330,130,110/440,130,110/);新砂轮1直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,150,110/440,150,110/);砂轮1当前直径
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/330,170,110/440,170,110/);修整时砂轮1转速

	DEF VAR23=(I/*0=$85800,1=$85801//$85350,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[41]"/0,0,0/440,220,60/);砂轮2状态
	DEF VAR41=(I/*0=$85014,1=$85013//$85807,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[47]"/0,0,0/505,220,30/);砂轮2是否修整
	DEF VAR8=(I/0,1000//$85341,$85341,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[27]"/330,240,110/440,240,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[29]"/330,260,110/440,260,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[31]"/330,280,110/440,280,110/);精修速度
	DEF VAR24=(R/0,1000//$85802,$85802,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[38]"/330,300,110/440,300,110/);新砂轮2直径
	DEF VAR25=(R/0,1000//$85803,$85803,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[39]"/330,320,110/440,320,110/);砂轮2当前直径
	DEF VAR27=(I///$85805,$85805,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[44]"/330,340,110/440,340,110/);修整时砂轮2转速
	...
	DEF VAR26=(R/0,1000//$85804,$85804,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[40]"/80,300,110/210,300,110/);砂轮1&2中心距
...
//M(Mask21/$85028//)
	...
	DEF VAR0=(R///$87010,$87010,,$85043/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/160,50,120/260,50,110/);左端面U轴对刀位置
	DEF VAR1=(R///$87011,$87011,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[25]"/350,50,120/470,50,110/);左端面Z轴初始接触位置
    DEF VAR2=(R///$87012,$87012,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[30]"/160,80,120/260,80,110/);C轴转速
	DEF VAR3=(R1///$87013,$87013,,$85050/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[99]"/390,80,120/470,80,110/);左端面磨削循环计数
    DEF VAR4=(R1///$87014,$87014,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/160,110,120/260,110,110/);左端面磨削设定循环计数
	DEF VAR5=(R///$87015,$87015,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/380,110,120/470,110,110/);左端面磨削进给量
	DEF VAR6=(R///$87016,$87016,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/140,140,120/260,140,110/);左端面Z轴当前接触位置
	
	DEF Line1=(S////wr1///0,0,0,0/130,190,600,5/,3/)
	
	DEF Line2=(S////wr1///0,0,0,0/130,0,5,190/,3/)
	
	DEF Line3=(S////wr1///0,0,0,0/130,186,5,185/,3/)
	
	DEF work1=(I///,$87025,,/wr0,FS3///150,10,150);
	
	DEF VAR7=(R///$87017,$87017,,$85043/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/160,250,120/260,250,110/);右端面U轴对刀位置
	DEF VAR8=(R///$87018,$87018,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[25]"/350,250,120/470,250,110/);右端面Z轴初始接触位置
    DEF VAR9=(R///$87019,$87019,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[30]"/160,280,120/260,280,110/);C轴转速
	DEF VAR10=(R1///$87020,$87020,,$85050/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[99]"/380,280,120/470,280,110/);右端面磨削循环计数
    DEF VAR11=(R1///$87021,$87021,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/160,310,120/260,310,110/);右端面磨削设定循环计数
	DEF VAR12=(R///$87022,$87022,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/380,310,120/470,310,110/);右端面磨削进给量
	DEF VAR13=(R///$87023,$87023,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/140,340,120/260,340,110/);右端面Z轴当前接触位置
	DEF VAR14=(R///$87024,$87024,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[28]"/380,340,120/470,340,110/);右端面U轴插补进给深度
