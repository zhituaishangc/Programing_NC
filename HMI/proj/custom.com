...
//M(Mask18/$85020//)
	...
	DEF PITCH_COM=(R/-500,500//$85105,$85105,$85043,/WR2//"/NC/_N_NC_GD2_ACX/INI[25]"/360,210,202/460,210,60/);全长导程补偿

	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/270,60,70/);选择对刀位置
	DEF VAR12=(R/-500,500//$85151,$85150,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[12]"/215,305,165/280,305,60/);测头接触位
	DEF VAR13=(R/-500,500//$85153,$85152,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[13]"/215,325,165/280,325,60/);砂轮接触位
	DEF VAR15=(R/0,100//$85155,$85154,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[19]"/215,345,165/280,345,60/);工件槽深
	...
	DEF VAR16=(R///$85156,$85156,$85043,/WR1//"$AC_DRF[X]"/10,285,210/120,285,60/);DRF_X
	DEF VAR17=(R///$85157,$85157,$85043,/WR1//"$AC_DRF[Z]"/10,305,210/120,305,60/);DRF_Z
	DEF VAR19=(R///$85158,$85158,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[5]"/10,325,180/80,325,60/);当前磨削接触位1
	DEF WHELL_POS_INI=(R///$85169,$85169,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,345,180/80,345,60/);初始磨削接触位1(对刀完成后磨削接触位)
	DEF VAR31=(R///$85171,$85171,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[16]"/190,325,180/270,325,60/);当前磨削接触位2
	DEF VAR32=(R///$85172,$85172,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[17]"/190,345,180/270,345,60/);初始磨削接触位2(对刀完成后磨削接触位)
	...
	DEF VAR27=(I/0,500///WR4//"$MN_USER_DATA_INT[0]"/0,0,0/0,0,0/);润滑间歇时间调用值
	DEF VAR28=(I/0,500///WR4//"$MN_USER_DATA_INT[1]"/0,0,0/0,0,0/);润滑启动时间调用值
	DEF VAR29=(I/0,500//$85127,$85127,$85048,/WR2//"/NC/_N_NC_GD2_ACX/INI[22]"/380,320,182/460,320,60/);润滑间歇时间输入值
	DEF VAR30=(I/0,500//$85126,$85126,$85047,/WR2//"/NC/_N_NC_GD2_ACX/INI[23]"/380,345,182/460,345,60/);润滑启动时间输入值
...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR2/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/335,30,60/);砂轮1状态
	DEF VAR23=(I/*0=$85800,1=$85801//$85350,,,/WR2/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[41]"/0,0,0/440,30,60/);砂轮2状态
	DEF VAR40=(I/*0=$85014,1=$85013//$85806,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[46]"/0,0,0/400,30,30/);砂轮1是否修整
	DEF VAR41=(I/*0=$85014,1=$85013//$85807,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[47]"/0,0,0/505,30,30/);砂轮2是否修整
	...
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR2/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[24]"/330,250,110/440,250,110/);新砂轮1直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,270,110/440,270,110/);砂轮1当前直径
	...
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/330,310,110/440,310,110/);修整时砂轮1转速
	
	DEF VAR24=(R/0,1000//$85802,$85802,,$85043/WR2/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[38]"/100,250,110/210,250,110/);新砂轮2直径
	DEF VAR25=(R/0,1000//$85803,$85803,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[39]"/100,270,110/210,270,110/);砂轮2当前直径

	DEF VAR26=(R/0,1000//$85804,$85804,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[40]"/100,290,110/210,290,110/);砂轮1&2中心距
	DEF VAR27=(I///$85805,$85805,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[44]"/100,310,110/210,310,110/);修整时砂轮2转速
	...
	DEF WHEEL1_MIN=(R/0,100//$85810,$85810,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[36]"/100,340,110/210,340,110/);砂轮1最小直径
	DEF WHEEL2_MIN=(R////WR4//"/NC/_N_NC_GD2_ACX/DRESSER[45]"/0,0,0/0,0,0/);砂轮2最小直径
	DEF WHEEL_MAX=(R/0,100//$85811,$85811,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[50]"/330,340,110/440,340,110/);砂轮最大磨削直径
...
//M(Mask17/$85379/"panel_17_1_chs.png"/)
	...
	DEF VAR12=(R/-800,800//$85342,$85342,,$85043/WR1/"panel_17_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[22]"/330,50,110/440,50,110/);砂轮1&2与修整轮Z中心
	DEF VAR11=(R/0,80//$85332,$85332,,$85047/WR2/"panel_17_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[19]"/330,70,110/440,70,110/);滚压轮停留时间
	
	DEF VAR2=(R/0,50//$85330,$85330,,$85043/WR2/"panel_17_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[2]"/330,110,110/440,110,110/);齿高

	DEF VAR1=(R/-500,500//$85331,$85331,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,90,110/440,90,110/);砂轮1NC用初始接触
	DEF VAR3=(R/-500,500//$85398,$85398,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/330,140,110/440,140,110/);砂轮1初始接触位置
	DEF VAR5=(R/-500,500//$85399,$85399,,$85043/WR1/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/330,160,110/440,160,110/);砂轮1当前接触位置
	
	DEF VAR20=(R/-800,800//$85808,$85808,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[48]"/330,180,110/440,180,110/);砂轮开到修整断面位置
	DEF VAR21=(R/-800,800//$85809,$85809,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[49]"/330,200,110/440,200,110/);修整轮到修整端面距离

	DEF VAR7=(R/0,500//$85396,$85396,,$85043/WR2/"panel_17_5_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[1]"/330,240,110/440,240,110/);修整轮直径
	DEF VAR8=(R/0,60//$85397,$85397,,$85046/WR2/"panel_17_6_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[2]"/330,260,110/440,260,110/);修整轮线速度
	DEF VAR9=(I///$85325,$85325,,$85044/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[20]"/330,280,110/440,280,110/);修整轮转速

	DEF VAR0=(R/0,800//$85329,$85329,,$85043/WR2/"panel_17_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/330,20,110/440,20,110);回零时砂轮1与修整轮中间距

	DEF VAR13=(R/-500,500//$85333,$85333,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[23]"/330,300,110/440,300,110/);砂轮2NC用初始接触
	DEF VAR14=(R/-500,500//$85334,$85334,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[25]"/330,320,110/440,320,110/);砂轮2初始接触位置
	DEF VAR15=(R/-500,500//$85335,$85335,,$85043/WR1/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[21]"/130,300,110/240,300,110/);砂轮2当前接触位置

	DEF VAR16=(R/-500,500//$85336,$85336,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[42]"/130,320,110/240,320,110/);修整轮相对砂轮1&2修整起点位置X坐标
