...
//M(Mask2/$85021/"panel_2_0_chs.png"/)
	...
	CHANGE(TECH_CHECK)
		IF (QCHECK.VAL==1)AND(VAR0.VAL<>1);循环启动按下,不是DIY工艺
			IF TECH_CHECK.VAL==0
				VAR10.WR=1
				VAR19.WR=1
			ELSE
			...
			ENDIF
		ENDIF
		IF (QCHECK.VAL<>1)AND(VAR0.VAL<>1);循环启动未按下,不是DIY工艺
			VAR10.WR=2
			VAR11.WR=2
			VAR12.WR=2
			VAR13.WR=2
...
//M(Mask11/$85379/"panel_4_1_chs.png"/)
	...
	DEF VAR11=(R/0,80//$85332,$85332,,$85047/WR2/"panel_4_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[19]"/330,35,110/440,35,110/);滚压轮停留时间
	
	DEF VAR0=(R/0,800//$85329,$85329,,$85043/WR2/"panel_4_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/330,60,110/440,60,110/1,7);回零时两轮中间距
