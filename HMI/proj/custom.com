...
//S(Start)
	...
	DEF TYPE=(R////WR4//"/NC/_N_NC_GD2_ACX/GRIND[1]"/0,0,0/0,0,0/);磨削类型
...
//M(MASK1/$85066//)
	...
	DEF VAR1=(I/*0=$85014,1=$85013//$85032,$85031,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[42]"/400,60,70/490,60,30);内螺纹磨削开关
	DEF VAR2=(I/*0=$85014,1=$85013//$85034,$85033,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[44]"/400,90,70/490,90,30);外圆磨削开关
	DEF VAR3=(I/*0=$85014,1=$85013//$85035,$85029,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[45]"/400,120,100/490,120,30);左端面磨削开关
	DEF VAR4=(I/*0=$85014,1=$85013//$85036,$85030,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[46]"/400,150,100/490,150,30);右端面磨削开关
	
	DEF VAR5=(S///,$85067,,/wr1///400,200,200,/);修整开关设置
	DEF VAR6=(I/*0=$85014,1=$85013//$85162,$85162,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND[2]"/400,230,100/490,230,30/);修整总开关
	DEF VAR7=(I/*0=$85014,1=$85013//$86996,$86996,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[5]"/400,260,100/490,260,30/);螺纹修整开关
	DEF VAR8=(I/*0=$85014,1=$85013//$86997,$86997,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[111]"/400,290,100/490,290,30);外圆修整开关
	DEF VAR9=(I/*0=$85014,1=$85013//$87024,$87024,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[112]"/400,320,/490,320,30);端面修整开关
	
	HS1=("工件选项",ac7,se3);工件选项
...
//M(MASK2/$85020//)
	...
	DEF VAR1=(I/*0=$85135,1=$85136,2=$85137,3=$85138,4=$85139,5=$86999//$85134,,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND[1]"/0,0,0/10,10,70/);磨削类型
	...
	DEF VAR16=(R///$85156,$85156,$85043,/WR1//"$AC_DRF[X]"/10,320,252/160,320,60/);DRF_X
	DEF VAR17=(R///$85157,$85157,$85043,/WR1//"$AC_DRF[Z]"/10,340,252/160,340,60/);DRF_Z
...
;;;;;;;;;;;;;;;;;;;MASK3:工艺参数;;;;;;;;;;;;;;;;;;;;;;;;;
//M(Mask3/$85021/"panel_2_0_chs.png"/)
...
;;;;;;;;;;;;;;;;;;;MASK4:修整参数;;;;;;;;;;;;;;;;;;;;;;;;;
//M(Mask4/$85022/"panel_3_4_chs.png"/)

	DEF VAR0=(R///$85366,$85366,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[10]"/100,10,120/200,10,110/);累计修整量
...
;;;;;;;;;;;;;;;;;;;MASK5:修整参数_XZ单滚轮;;;;;;;;;;;;;;;;
//M(Mask5/$85380/"panel_12_1_chs.png"/)
...
;;;;;;;;;;;;;;;;;;;MASK6:齿形参数_双圆弧;;;;;;;;;;;;;;;;;;
//M(Mask6/$85385/"panel_9_1_chs.png"/)
...
;;;;;;;;;;;;;;;;;;;MASK7:修整返回;;;;;;;;;;;;;;;;;;;;;;;;;
//M(Mask7/$85022/"panel_3_4_chs.png"/)
...
;;;;;;;;;;;;;;;;;;;MASK10:侧面修整参数;;;;;;;;;;;;;;;;;;;;
//M(MASK10/$85027/"panel_3_4_chs.png"/)

	DEF VAR1=(R///$87021,$87021,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[107]"/80,10,150/220,10,110/);砂轮侧面累计修整量
	DEF WHEEL_STATUS=(I/*0=$87008,1=$87009//$85350,$85350,,/WR1/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[90]"/330,10,110/440,10,60/);砂轮状态
	...
	DEF VAR8=(R///$87018,$87018,,$85043/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[101]"/330,200,110/440,200,110/);U轴修整起点
	DEF VAR9=(R///$87019,$87019,,$85043/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[102]"/330,220,110/440,220,110/);U轴修整深度
	
	DEF VAR10=(R///$87020,$87020,,$85043/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[100]"/330,250,110/440,250,110/);Z轴修整起点
    DEF VAR11=(R///$87023,$87023,,$85043/WR1/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[109]"/330,270,110/440,270,110/);Z轴修整当前位置
...
//M(Mask11/$85029//)
    ...
    DEF VAR4=(I/0,100//$87013,$87013,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/330,80,120/435,80,110/);左端面磨削设定循环计数
	DEF VAR5=(I/0,100//$87029,$87029,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[107]"/320,200,120/435,200,110/);左端面磨削中修整
    ...
    DEF VAR9=(R///$87028,$87028,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[105]"/70,10,150/200,10,110/);磨削量累计
...
//M(Mask12/$85030//)
    ...
    DEF VAR4=(I/0,100//$87013,$87013,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[102]"/330,80,120/435,80,110/);右端面磨削设定循环计数
	DEF VAR5=(I/0,100//$87029,$87029,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[106]"/320,230,120/435,230,110/);右端面磨削中修整
