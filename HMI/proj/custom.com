...
//M(Mask1/$85020//)
	...
	DEF VAR6=(I///$85102,$85102,,/WR2//"/NC/_N_NC_GD2_ACX/WORK[1]"/340,60,70/440,60,60/);工件头数
	DEF VAR7=(R4///$85104,$85104,,/WR2//"/NC/_N_NC_GD2_ACX/INI[5]"/340,85,80/440,85,60/);工件螺距
	DEF VAR8=(R4///$85108,$85108,,/WR2//"/NC/_N_NC_GD2_ACX/INI[2]"/340,110,80/440,110,60/);工件左端
	DEF VAR9=(R4///$85109,$85109,,/WR2//"/NC/_N_NC_GD2_ACX/INI[3]"/340,135,80/440,135,60/);工件右端
	DEF VAR10=(R///$85106,$85106,,/WR2//"/NC/_N_NC_GD2_ACX/INI[11]"/340,160,80/440,160,60/);退刀距离
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148,3=$85149//$85145,,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/240,35,70/);对刀位置
	DEF VAR12=(R///$85151,$85150,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[12]"/335,185,85/440,185,60/);测头接触位
	DEF VAR13=(R///$85153,$85152,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[13]"/335,210,85/440,210,60/);砂轮接触位
	DEF VAR14=(R///,,,/WR4//"/Plc/Q116.4"/0,0,0/0,0,0/);TEMP
	DEF VAR15=(R///$85155,$85154,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[19]"/340,235,85/440,235,60/);工件槽深
	...
	DEF VAR19=(R///$85158,$85158,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[5]"/20,345,100/125,345,60/);磨削接触位
...
//M(Mask15/$85379//)
	...
	DEF VAR22=(I/*0=$85014,1=$85013//$85337,$85337,,/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[17]"/330,240,40/440,240,50/);液压左
	DEF VAR23=(I/*0=$85014,1=$85013//$85338,$85338,,/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[18]"/330,260,40/440,260,50/);液压右
...
//G(TECH_GRID/0/7)
	...
	(R3///$85203,$85203/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[1]"/103/,10)
	(R3///$85204,$85204/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[2]"/103/,10)
	(R3///$85205,$85205/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[3]"/103/,10)
	(R3///$85206,$85206/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[4]"/103/,10)
