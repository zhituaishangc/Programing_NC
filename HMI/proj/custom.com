...
//M(Mask21/$85028//)
	...
	DEF VAR1=(R///$87011,$87011,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[25]"/340,50,120/460,50,110/);左端面Z轴初始接触位置
	...
	DEF VAR5=(R///$87015,$87015,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/370,110,120/460,110,110/);左端面磨削进给量
	DEF VAR6=(R///$87016,$87016,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/130,140,120/250,140,110/);左端面Z轴当前接触位置
	...
	DEF VAR8=(R///$87018,$87018,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[25]"/340,250,120/460,250,110/);右端面Z轴初始接触位置
    DEF VAR9=(R///$87019,$87019,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[30]"/150,280,120/250,280,110/);C轴转速
	DEF VAR10=(R1///$87020,$87020,,$85050/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[99]"/370,280,120/460,280,110/);右端面磨削循环计数
    DEF VAR11=(R1///$87021,$87021,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/150,310,120/250,310,110/);右端面磨削设定循环计数
	DEF VAR12=(R///$87022,$87022,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/370,310,120/460,310,110/);右端面磨削进给量
	DEF VAR13=(R///$87023,$87023,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/130,340,120/250,340,110/);右端面Z轴当前接触位置
