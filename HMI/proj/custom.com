...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF VAR5=(I/*0=$85142,1=$85143/0/$85144,,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[8]"/0,0,0/440,10,63/);对刀方式
	DEF PIECE_VOLUME=(I/*0=$85166,1=$85167//$85168,,,/WR2/"panel_1_17_chs.png"/"/NC/_N_NC_GD2_ACX/INI[27]"/0,0,0/440,10,63/);单件/批量磨削方式选择
	...
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR2/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/240,35,70/);选择对刀位置
	...
	DEF VAR16=(R///$85156,$85156,$85043,/WR1//"$AC_DRF[X]"/20,285,220/135,285,60/);DRF_X
	DEF VAR17=(R///$85157,$85157,$85043,/WR1//"$AC_DRF[Z]"/20,305,220/135,305,60/);DRF_Z
	DEF VAR19=(R///$85158,$85158,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[5]"/20,325,220/135,325,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[14]"/20,345,220/135,345,60/);初始磨削接触位(对刀完成后磨削接触位)
...
//M(Mask11/$85379/"panel_4_1_chs.png"/)
	...
	DEF VAR0=(R/0,800//$85329,$85329,,$85043/WR2/"panel_4_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/330,35,110/440,35,110/1,7);回零时两轮中间距
