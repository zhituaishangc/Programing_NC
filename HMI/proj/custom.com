...
//M(Mask3/$85021/"panel_2_0_chs.png"/)
	...
	;是否磨螺纹选择
	DEF ISTEXT=(I///$85031,$85031,,/WR2///410,5,65/0,0,0);
	DEF ISUSE=(I/*0=$85014,1=$85013//$85032,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[42]"/,,/490,5,30);
...
//M(Mask4/$85022/"panel_3_4_chs.png"/)
	...
	DEF ISTEXT=(R///$86996,$86996,,/WR1///100,40,145/0,0,0/);修整开关文字
	DEF ISDRESS=(I/*0=$85014,1=$85013//,,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[5]"/,,/255,40,30);修整开关
...
//M(MASK8/$85027/"panel_3_4_chs.png"/)
	...
	DEF ISTEXT=(R///$86997,$86997,,/WR1///100,40,120/0,0,0/);修整开关文字
	DEF ISDRESS=(I/*0=$85014,1=$85013//,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[111]"/,,/230,40,30);修整开关
...
//M(MASK9/$85021/"panel_2_0_chs.png"/)
	...
	;是否磨外圆
	DEF VAR0=(I///$85033,$85034,,/WR2///410,25,65/0,0,0)
	DEF ISGRIND=(I/*0=$85014,1=$85013//$85034,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[44]"/,,/490,25,30);
...
//M(MASK10/$85027/"panel_3_4_chs.png"/)
	...
	DEF ISTEXT=(R///$86997,$86997,,/WR1///80,40,120/0,0,0/);修整开关文字
	DEF ISDRESS=(I/*0=$85014,1=$85013//,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[112]"/,,/200,40,30);修整开关
