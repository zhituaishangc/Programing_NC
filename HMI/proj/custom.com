...
//M(Mask1/$85020//)
	...
	DEF VAR6=(I///$85102,$85102,$85051,/WR2//"/NC/_N_NC_GD2_ACX/WORK[1]"/340,60,202/440,60,60/);工件头数
	DEF VAR7=(R4///$85104,$85104,$85043,/WR2//"/NC/_N_NC_GD2_ACX/INI[5]"/340,85,202/440,85,60/);工件螺距
	DEF VAR8=(R4///$85108,$85108,$85043,/WR2//"/NC/_N_NC_GD2_ACX/INI[2]"/340,110,202/440,110,60/);工件左端
	DEF VAR9=(R4///$85109,$85109,$85043,/WR2//"/NC/_N_NC_GD2_ACX/INI[3]"/340,135,202/440,135,60/);工件右端
	DEF VAR10=(R///$85106,$85106,$85043,/WR2//"/NC/_N_NC_GD2_ACX/INI[11]"/340,160,202/440,160,60/);退刀位置
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148,3=$85149//$85145,,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/240,35,70/);对刀位置
	DEF VAR12=(R///$85151,$85150,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[12]"/335,185,208/440,185,60/);测头接触位
	DEF VAR13=(R///$85153,$85152,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[13]"/335,210,208/440,210,60/);砂轮接触位
	DEF VAR14=(R///,,,/WR4//"/Plc/Q116.4"/0,0,0/0,0,0/);TEMP
	DEF VAR15=(R///$85155,$85154,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[19]"/340,235,202/440,235,60/);工件槽深
	DEF VAR16=(R///$85156,$85156,$85043,/WR1//"$AC_DRF[X]"/20,295,210/125,295,60/);DRF_X
	DEF VAR17=(R///$85157,$85157,$85043,/WR1//"$AC_DRF[Z]"/20,320,210/125,320,60/);DRF[Z]
