...
//M(Mask1/$85020//)
	...
	DEF VAR1=(I/*0=$85135,1=$85136,2=$85137,3=$85138,4=$85139//$85134,,,/WR2//"/NC/_N_NC_GD2_ACX/GRINDING[1]"/0,0,0/40,10,60/);磨削类型
	DEF VAR2=(I/*0=$85014,1=$85013//$85162,$85162,,/WR1//"/NC/_N_NC_GD2_ACX/GRINDING[2]"/140,10,40/180,10,50/);是否修整
	DEF VAR3=(I/*0=$85014,1=$85013//$85163,$85163,,/WR1//"/NC/_N_NC_GD2_ACX/GRINDING[3]"/240,10,40/280,10,50/);是否对刀
	DEF VAR4=(I/*0=$85100,1=$85140//$85141,,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[9]"/0,0,0/340,10,65/);对刀类型
	DEF VAR5=(I/*0=$85142,1=$85143//$85144,,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[8]"/0,0,0/440,10,63/);对刀方式
	...
	DEF VAR23=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2//"/NC/_N_NC_GD2_ACX/INI[17]"/335,285,80/370,285,50/);是否有螺旋升角
	...
	DEF VAR27=(I/0,500//$85127,$85127,$85048,/WR4//"/Plc/DB4900.DBW6"/335,310,202/440,310,50/);润滑间歇时间调用值
	DEF VAR28=(I/0,500//$85126,$85126,$85047,/WR4//"/Plc/DB4900.DBD8"/335,335,202/440,335,50/);润滑启动时间调用值
...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF VAR5=(I/*0=$85142,1=$85143/0/$85144,,,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[8]"/0,0,0/270,35,70);对刀方式(手动/自动)
	...
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR2/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/270,60,70/);选择对刀位置
