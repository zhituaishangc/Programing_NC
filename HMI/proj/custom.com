...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF VAR5=(I/*0=$85142,1=$85143//$85144,,,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[8]"/0,0,0/270,35,70);对刀方式(手动/自动)
	...
	DEF VAR23=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2//"/NC/_N_NC_GD2_ACX/INI[17]"/360,285,80/405,285,30/);是否有螺旋升角
	DEF VAR24=(I/-45,45//$85160,,,$85042/WR4//"/NC/_N_NC_GD2_ACX/INI[18]"/0,285,0/455,285,75/);度
	DEF VAR25=(I/0,59//$85161,,,$85053/WR4//"/NC/_N_NC_GD2_ACX/INI[19]"/0,285,0/490,285,70/);分
	DEF VAR26=(I/0,59//$85161,,,$85054/WR4//"/NC/_N_NC_GD2_ACX/INI[20]"/0,285,0/520,285,70/);秒
...
//M(Mask3/$85022//)
	...
	DEF VAR2=(I/*0=$85380,1=$85381,2=$85382//$85388,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/0,0,0/440,10,60/);修整轮类型
