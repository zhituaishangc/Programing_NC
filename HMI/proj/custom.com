...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF WORK_MID_DIA=(R/0,200//$85171,$85171,$85043,/WR4//"/NC/_N_NC_GD2_ACX/INI[40]"/360,310,202/460,310,60/);工件中径
	...
	SUB(UP3)
		IF VAR23.VAL==1
			IF WORK_MID_DIA.VAL>0
				...
				VAR25.VAL=1
				VAR26.VAL=1
				;VAR24.VAL=CALC_FLOOR(ATAN((VAR6.VAL*VAR7.VAL)/(PI*WORK_MID_DIA.VAL)))
				;VAR25.VAL=CALC_FLOOR((ATAN((VAR6.VAL*VAR7.VAL)/(PI*WORK_MID_DIA.VAL))-VAR24.VAL)*60)
				;VAR26.VAL=CALC_FLOOR(((ATAN((VAR6.VAL*VAR7.VAL)/(PI*WORK_MID_DIA.VAL))-VAR24.VAL)*60-VAR25.VAL)*60)
			ENDIF
		ENDIF
	END_SUB
...
//M(Mask9/$85385/"panel_9_1_chs.png"/)
	...
	DEF VAR15=(R///$85449,$85449,,$85043/WR2/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[17]"/320,270,150/470,270,110/);左滚道水平偏心调整
	DEF VAR16=(R///$85450,$85450,,$85043/WR2/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[18]"/320,290,150/470,290,110/);右滚道水平偏心调整
	DEF VAR17=(R///$85451,$85451,,$85043/WR2/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[19]"/320,310,150/470,310,110/);左滚道垂直偏心调整
	DEF VAR18=(R///$85452,$85452,,$85043/WR2/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[20]"/320,330,150/470,330,110/);右滚道垂直偏心调整
	
    DEF VAR31=(R///$85453,$85453,,$85043/WR1/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[13]"/20,270,150/160,270,110/);当前左滚道水平偏心
	DEF VAR32=(R///$85454,$85454,,$85043/WR1/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[14]"/20,290,150/160,290,110/);当前右滚道水平偏心
	DEF VAR33=(R///$85455,$85455,,$85043/WR1/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[15]"/20,310,150/160,310,110/);当前左滚道垂直偏心
	DEF VAR34=(R///$85456,$85456,,$85043/WR1/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[16]"/20,330,150/160,330,110/);当前右滚道垂直偏心
