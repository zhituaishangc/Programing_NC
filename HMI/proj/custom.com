...
//M(Mask2/$85021/"panel_2_0_chs.png"/)
	...
	DEF ISUSE=(I/*0=$85013,1=$85014//$85032,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[42]"/,,/490,5,30);
...
//M(MASK19/$85021/"panel_2_0_chs.png"/)
	...
	DEF ISGRIND=(I/*0=$85013,1=$85014//$85034,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[44]"/,,/490,25,30);
...
//M(MASK20/$85027/"panel_3_4_chs.png"/)
	...
	DEF ISDRESS=(I/*0=$85013,1=$85014//$85034,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[44]"/,,/230,40,30);修整开关
...
//M(Mask21/$85029//)
	...
	DEF VAR1=(R///$87010,$87010,,$85043/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/330,50,120/435,50,110/);右端面U轴对刀位置
	...
	DEF VAR8=(R///$87012,$87012,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[39]"/330,230,120/435,230,110/);C轴转速
	DEF VAR9=(R///$85215,$85215,,$85045/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/330,250,120/435,250,110/);右端面磨削速度
    DEF VAR10=(R///$87022,$87022,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[107]"/70,10,150/200,10,110/);砂轮侧面累计修整量
...
//M(MASK22/$85027/"panel_3_4_chs.png"/)
	...
	DEF VAR8=(R///$87019,$87019,,$85043/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[101]"/330,200,110/440,200,110/);U轴修整起点
    ...
    DEF VAR11=(R///$87011,$87011,,$85043/WR1/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[109]"/330,270,110/440,270,110/);Z轴修整当前位置
	...
	DEF VAR0=(I/*0=$85014,1=$85013//$85162,$85162,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[99]"/330,10,110/370,10,30/);是否修整
