...
//M(Mask18/$85020/"panel_18_4_chs.png"/)
	...
	DEF VAR19=(R///$85158,$85158,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[5]"/10,335,210/120,335,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,360,210/120,360,60/);初始磨削接触位(对刀完成后磨削接触位)

	DEF VAR14=(R///,,,/WR4//"/Plc/DB4900.DBX0.0"/0,0,0/0,0,0/);TEMP
	DEF VAR18=(R///,,,/WR4//"/Plc/DB4900.DBX1.0"/0,0,0/0,0,0/);TEMP

	DEF VAR20=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_18_12_chs.png"/"/NC/_N_NC_GD2_ACX/INI[12]"/360,285,80/405,285,30/);是否有锥度
	DEF VAR21=(I/0,10//$85160,,,$85052/WR2/"panel_18_13_chs.png"/"/NC/_N_NC_GD2_ACX/INI[13]"/0,285,0/460,285,75/);锥度分子
	DEF VAR22=(I/0,800//$85161,,,/WR2/"panel_18_14_chs.png"/"/NC/_N_NC_GD2_ACX/INI[14]"/0,0,0/490,285,30/);锥度分母

	DEF VAR23=(I/*0=$85014,1=$85013//$85164,$85164,,/WR2/"panel_18_18_chs.png"/"/NC/_N_NC_GD2_ACX/INI[17]"/360,310,80/405,310,30/);是否有螺旋升角
	DEF VAR24=(I/0,45//$85055,,,$85042/WR2/"panel_18_19_chs.png"/"/NC/_N_NC_GD2_ACX/INI[18]"/0,310,0/460,310,75/);度
	DEF VAR25=(I/0,59//$85056,,,$85053/WR2/"panel_18_20_chs.png"/"/NC/_N_NC_GD2_ACX/INI[19]"/0,310,0/495,310,70/);分
	DEF VAR26=(I/0,59//$85057,,,$85054/WR2/"panel_18_21_chs.png"/"/NC/_N_NC_GD2_ACX/INI[20]"/0,310,0/525,310,70/);秒

	DEF C_INIT=(R/0,360//$85812,$85812,$85042,/WR2/"panel_18_22_chs.png"/"/NC/_N_NC_GD2_ACX/INI[28]"/360,235,202/460,235,60/);头架在程序结束调整到合适角度
	DEF Z_INIT=(R/-500,500//$85813,$85813,$85043,/WR2/"panel_18_23_chs.png"/"/NC/_N_NC_GD2_ACX/INI[29]"/360,260,202/460,260,60/);内螺纹时台面起始位置

	DEF VAR27=(I/0,500///WR4//"$MN_USER_DATA_INT[0]"/0,0,0/0,0,0/);润滑间歇时间调用值
	DEF VAR28=(I/0,500///WR4//"$MN_USER_DATA_INT[1]"/0,0,0/0,0,0/);润滑启动时间调用值
	DEF VAR29=(I/0,500//$85127,$85127,$85048,/WR2/"panel_18_15_chs.png"/"/NC/_N_NC_GD2_ACX/INI[22]"/380,335,182/460,335,60/);润滑间歇时间输入值
	DEF VAR30=(I/0,500//$85126,$85126,$85047,/WR2/"panel_18_16_chs.png"/"/NC/_N_NC_GD2_ACX/INI[23]"/380,360,182/460,360,60/);润滑启动时间输入值
...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF WHEEL_MIN=(R/0,100//$85810,$85810,,$85043/WR2/"panel_3_11_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[36]"/80,320,130/210,320,110/);砂轮最小直径
...
//M(Mask17/$85379/"panel_17_1_chs.png"/)
	...
	DEF VAR0=(R/0,800//$85329,$85329,,$85043/WR2/"panel_17_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/325,10,110/440,10,110);回零时砂轮与修整轮中间距
	...
	DEF VAR1=(R/-500,500//$85331,$85331,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/310,260,130/440,260,110/);NC用初始接触
	DEF VAR3=(R/-500,500//$85398,$85398,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/310,280,130/440,280,110/);初始接触位置
	DEF VAR5=(R/-500,500//$85399,$85399,,$85043/WR1/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/310,300,130/440,300,110/);当前接触位置
