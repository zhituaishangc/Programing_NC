...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348//$85387,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/325,10,80/);修整器,界面调试用
	;DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/0/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/325,10,80/);修整器V_W,修整器,生成文件用
	;DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/1/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/325,10,80/);修整器X_Z,修整器,生成文件用
	;DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/2/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/325,10,80/);修整器成型V,修整器,生成文件用
	;DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/3/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/325,10,80/);修整器摆缸,修整器,生成文件用
	;DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/4/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/325,10,80/);修整器成型X,修整器,生成文件用
	...
	DEF VAR3=(S////WR4//"/NC/_N_NC_GD2_ACX/SHAPE"//325,30,80/);存储齿形程序名,蜗杆磨床时可手动输入
...
//M(Mask10/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR3=(S////WR4//"/NC/_N_NC_GD2_ACX/SHAPE"//325,30,80/);齿形,蜗杆磨修整返回
