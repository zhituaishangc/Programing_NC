...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	;DEF VAR7=(R3/0,50//$85173,$85173,$85043,/WR2/"panel_1_6_chs.png"/"/NC/_N_NC_GD2_ACX/INI[72]"/360,80,202/460,80,60/);蜗杆模数输入
...
//M(MASK_WORM_SHUANG/$85381//)
	...
	DEF VAR11=(R/-500,500//$85343,$85903,,/WR2//"$R[14]"/330,20,115/440,20,60/);双滚轮间距的中心和砂轮中心重合时的W坐标
	DEF VAR0=(R/0,300//$85902,$85390,,$85043/WR2//"$R[10]"/330,40,110/440,40,110/);修整轮圆弧中心间的距离

	DEF VAR9=(R/-5,5//$85901,$85900,,$85043/WR2//"$R[11]"/300,95,130/440,95,110/);右修整轮高出距离
	DEF VAR3=(R/-500,500//$85905,$85904,/WR2//"$R[15]"/300,115,130/440,115,60/);修整轮圆弧中心和砂轮中心在V方向重合时的V坐标
	DEF CURRENT_V=(R/-500,500//$85912,$85913,,/WR2//"$R[7]"/330,135,130/440,135,60/);修整轮与砂轮当前接触位置

	DEF VAR5=(R/-500,500//$85908,$85906,,/WR2//"$R[16]"/330,190,110/440,190,60/);修整结束水平轴停靠点
	DEF VAR6=(R/-500,500//$85909,$85907,,/WR2//"$R[17]"/330,210,110/440,210,60/);修整结束垂直轴停靠点
	...
	DEF DWHEEL_TIME=(R/0,500//$85911,$85910,,$85047/WR2//"$R[13]"/325,300,115/440,300,110/);修整轮冷却启动到修整轮启动之间的延时	
