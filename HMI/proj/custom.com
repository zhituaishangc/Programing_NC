...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF VAR1=(I/*0=$85135,1=$85136,2=$85137,3=$85138,4=$85139/0/$85134,,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND[1]"/0,0,0/60,10,60/);磨削类型
	DEF VAR2=(I/*0=$85014,1=$85013//$85162,$85162,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND[2]"/160,10,40/200,10,50/);是否修整
	DEF VAR3=(I/*0=$85014,1=$85013//$85163,$85163,,/WR1//"/NC/_N_NC_GD2_ACX/GRIND[3]"/265,10,40/300,10,50/);是否对刀
	DEF VAR4=(I/*0=$85100,1=$85140//$85141,,,/WR1/"panel_1_1_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[9]"/0,0,0/260,35,70);对刀类型(首次/二次)
	DEF VAR5=(I/*0=$85142,1=$85143/0/$85144,,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[8]"/0,0,0/440,10,63/);对刀方式(手动/自动)
	...
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR2/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/260,60,70/);选择对刀位置
	DEF VAR12=(R/-500,500//$85151,$85150,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[12]"/335,185,208/460,185,60/);测头接触位
	DEF VAR13=(R/-500,500//$85153,$85152,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[13]"/335,210,208/460,210,60/);砂轮接触位
	DEF VAR14=(R///,,,/WR4//"/Plc/DB4900.DBX0.0"/0,0,0/0,0,0/);TEMP
	DEF VAR15=(R/0,100//$85155,$85154,$85043,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[19]"/360,235,202/460,235,60/);工件槽深
	...
	DEF VAR27=(I/0,500//$85127,$85127,$85048,/WR4//"$MN_USER_DATA_INT[0]"/360,310,202/460,310,50/);润滑间歇时间调用值
	DEF VAR28=(I/0,500//$85126,$85126,$85047,/WR4//"$MN_USER_DATA_INT[1]"/360,335,202/460,335,50/);润滑启动时间调用值
	DEF VAR29=(I/0,500//$85127,$85127,$85048,/WR2/"panel_1_15_chs.png"/"/NC/_N_NC_GD2_ACX/INI[22]"/360,320,207/460,320,60/);润滑间歇时间输入值
	DEF VAR30=(I/0,500//$85126,$85126,$85047,/WR2/"panel_1_16_chs.png"/"/NC/_N_NC_GD2_ACX/INI[23]"/360,345,207/460,345,60/);润滑启动时间输入值
