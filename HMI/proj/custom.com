...
//M(Mask21/$85028//)
	...
	DEF VAR0=(R///$87010,$87010,,$85043/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/160,10,120/260,10,110/);左端面U轴对刀位置
	DEF VAR1=(R///$87011,$87011,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[25]"/350,10,120/470,10,110/);左端面Z轴初始接触位置
    DEF VAR2=(R///$87012,$87012,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[30]"/160,40,120/260,40,110/);C轴转速
	DEF VAR3=(R1///$87013,$87013,,$85050/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[99]"/390,40,120/470,40,110/);左端面磨削循环计数
    DEF VAR4=(R1///$87014,$87014,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/160,70,120/260,70,110/);左端面磨削设定循环计数
	DEF VAR5=(R///$87015,$87015,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/380,70,120/470,70,110/);左端面磨削进给量
	DEF VAR6=(R///$87016,$87016,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/140,100,120/260,100,110/);左端面Z轴当前接触位置
	
	DEF Line1=(S////wr1///0,0,0,0/0,180,600,5/,3/)
	
	DEF VAR7=(R///$87017,$87017,,$85043/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/160,210,120/260,210,110/);右端面U轴对刀位置
	DEF VAR8=(R///$87018,$87018,,$85043/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[25]"/350,210,120/470,210,110/);右端面Z轴初始接触位置
    DEF VAR9=(R///$87019,$87019,,$85044/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[30]"/160,240,120/260,240,110/);C轴转速
	DEF VAR10=(R1///$87020,$87020,,$85050/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[99]"/380,240,120/470,240,110/);右端面磨削循环计数
    DEF VAR11=(R1///$87021,$87021,,$85050/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[100]"/160,270,120/260,270,110/);右端面磨削设定循环计数
	DEF VAR12=(R///$87022,$87022,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[36]"/380,270,120/470,270,110/);右端面磨削进给量
	DEF VAR13=(R///$87023,$87023,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[37]"/140,300,120/260,300,110/);右端面Z轴当前接触位置
	DEF VAR14=(R///$87024,$87024,,$85043/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[28]"/380,300,120/470,300,110/);右端面U轴插补进给深度
